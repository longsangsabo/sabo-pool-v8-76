        ...
        <CardContent className="pt-6">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-muted-foreground">{profile.bio || 'Chưa có mô tả'}</p>
              ...
              <div className="flex flex-wrap gap-2 mt-2 justify-center md:justify-start">
                ...
                <Badge variant="outline">
                  {profile.role === 'player' ? 'Người chơi' : 
                   profile.role === 'club_owner' ? 'Chủ CLB' : 'Cả hai'}
                </Badge>
              </div>
            </div>
            ...
            {stats && (
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <div className="text-2xl font-bold text-primary">{stats.total_matches}</div>
                ...
                <div>
                  <div className="text-2xl font-bold text-yellow-600">{stats.spa_points}</div>
