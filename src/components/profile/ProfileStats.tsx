  ...
  const stats = [
    {
      ...
      subtitle: 'Trận thắng',
      icon: Trophy,
      bgClass: 'bg-gradient-to-br from-accent-green/10 to-accent-green/20 dark:from-accent-green/20 dark:to-accent-green/30',
    ...
    },
    {
      ...
      icon: Target,
      bgClass: 'bg-gradient-to-br from-primary/10 to-primary/20 dark:from-primary/20 dark:to-primary/30',
    ...
    },
    {
      ...
      icon: Users,
      bgClass: 'bg-gradient-to-br from-accent-purple/10 to-accent-purple/20 dark:from-accent-purple/20 dark:to-accent-purple/30',
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      {stats.map((stat, index) => {
        ...
        return (
          <Card key={index} className={`${stat.bgClass} ${stat.borderClass} border bg-card dark:bg-card`}>
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                ...
                <div className={`p-3 rounded-full bg-background/50 dark:bg-background/50`}>
