        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-card p-4 rounded-lg border">
            <div className="space-y-3">
              <h4 className="font-medium text-foreground text-sm">Xác minh hạng chính thức</h4>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Đăng ký xác minh hạng tại câu lạc bộ để có rank chính thức trong hệ thống
              </p>
              <Button 
          ...
          <div className="bg-card p-4 rounded-lg border">
            ...
            <div className="h-32 flex items-center justify-center text-muted-foreground">
              <p className="text-xs text-center">Biểu đồ ELO sẽ được hiển thị ở đây</p>
            </div>
          </div>
            ...
            <div className="space-y-2">
              {playerData.weekly_spa_rank && (
                <div className="flex justify-between items-center p-2 bg-blue-50 rounded">
                  ...
                  <span className="text-sm font-bold text-blue-600">#{playerData.weekly_spa_rank}</span>
                </div>
              )}
              {playerData.monthly_spa_rank && (
                <div className="flex justify-between items-center p-2 bg-green-50 rounded">
                  <span className="text-xs font-medium">Tháng này</span>
                  <span className="text-sm font-bold text-green-600">#{playerData.monthly_spa_rank}</span>
                </div>
              )}
