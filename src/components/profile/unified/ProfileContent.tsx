        ...
        <Tabs value={activeTab} onValueChange={onTabChange}>
            ...
            <div className='space-y-4'>
              ...
              >
                <div className='flex items-center justify-between mb-3'>
                  ...
                  <span
                    className={`text-sm font-racing-sans-one ${arenaMode ? 'text-cyan-400' : 'text-primary'}`}
                  >
              ...
              <div className='space-y-3'>
                ...
                {profile?.bio && (
                  <div
                    className={`p-3 rounded-lg ${arenaMode ? 'bg-slate-700/50' : 'bg-muted/50'}`}
                  >
          ...
          <TabsContent value='stats' className='mt-4'>
            <div className='space-y-4'>
              ...
              <div>
                <h3
                  className={`text-sm font-medium mb-3 ${arenaMode ? 'text-cyan-300' : ''}`}
                >
                  Hiệu suất gần đây
                </h3>
                <div className='grid grid-cols-2 gap-3'>
                  <div
                    className={`p-3 rounded-lg text-center ${arenaMode ? 'bg-slate-700/50' : 'bg-muted/50'}`}
                  >
                    <div
              ...
              <div>
                ...
                <div className='space-y-2'>
                  {[1, 2, 3].map((match, index) => (
                    <div
                      key={index}
                      className={`flex items-center justify-between p-2 rounded-lg ${arenaMode ? 'bg-slate-700/50' : 'bg-muted/50'}`}
                    >
                      <div className='flex items-center gap-2'>
                ...
                <div className='space-y-3'>
                  {profile.achievements.map(
                    (achievement: any, index: number) => (
                      <div
                        key={index}
                        className={`flex items-center gap-3 p-3 rounded-lg ${arenaMode ? 'bg-slate-700/50' : 'bg-muted/50'}`}
                      >
