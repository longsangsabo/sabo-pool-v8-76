...
const ProfileComparison = () => {
  const [activeView, setActiveView] = useState<'legacy' | 'optimized'>('optimized');
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card className="border-red-200 bg-red-50">
            ...
            <CardContent className="space-y-3">
              <div className="flex justify-between">
                ...
                <Badge variant="destructive">{metrics.legacy.scrollDistance}</Badge>
              </div>
              <div className="flex justify-between">
                <span className="text-sm">Cards per Screen</span>
                <Badge variant="destructive">{metrics.legacy.cardsPerScreen}</Badge>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <Badge variant="destructive">{metrics.legacy.touchAccuracy}</Badge>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-green-200 bg-green-50">
            ...
            <CardContent className="space-y-3">
              <div className="flex justify-between">
                <span className="text-sm">Scroll Distance</span>
                <Badge className="bg-green-600">{metrics.optimized.scrollDistance}</Badge>
              </div>
              <div className="flex justify-between">
                <span className="text-sm">Cards per Screen</span>
                <Badge className="bg-green-600">{metrics.optimized.cardsPerScreen}</Badge>
              </div>
              <div className="flex justify-between">
                <span className="text-sm">Time to Info</span>
                <Badge className="bg-green-600">{metrics.optimized.timeToInfo}</Badge>
              </div>
              <div className="flex justify-between">
                <span className="text-sm">Touch Accuracy</span>
                <Badge className="bg-green-600">{metrics.optimized.touchAccuracy}</Badge>
              </div>
            </CardContent>
          </Card>
        </div>
                ...
                <div key={index} className="p-3 border rounded-lg space-y-2">
                  ...
                  <div className="text-sm space-y-1">
                    <div className="text-red-600">
                      <span className="font-medium">Before:</span> {feature.before}
                    </div>
                    <div className="text-green-600">
                      <span className="font-medium">After:</span> {feature.after}
                    </div>
