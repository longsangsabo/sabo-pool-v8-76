...
import { SaboTechBorder, SaboTechButton, SaboTechCard, SaboTechInput, SaboTechAvatar } from '@/components/ui/sabo-tech-border';
  ...
  return (
    <div className="p-8 space-y-8 bg-background min-h-screen">
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-semibold text-foreground">Border Variants</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          
          <SaboTechBorder variant="primary" interactive>
            <div className="p-6 text-center">
              <h3 className="font-bold text-lg mb-2">Primary Border</h3>
              <p className="text-sm text-muted-foreground">Golden tech border with animated pulse</p>
            </div>
          </SaboTechBorder>
          ...
          <SaboTechBorder variant="secondary" interactive>
            <div className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">Blue tech border with moving lines</p>
            </div>
          </SaboTechBorder>
          ...
          <SaboTechBorder variant="success" interactive>
            <div className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">Green tech border for victories</p>
            </div>
          </SaboTechBorder>
          ...
          <SaboTechBorder variant="warning" interactive>
            <div className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">Red tech border with alert pulse</p>
            </div>
          </SaboTechBorder>
          ...
          <SaboTechBorder variant="premium" interactive>
            <div className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">Purple premium border with conic rotation</p>
            </div>
          </SaboTechBorder>
      ...
      {/* Rank-based Borders */}
      <section className="space-y-6">
        <h2 className="text-2xl font-semibold text-foreground">Rank-based Borders</h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {(['K', 'I', 'H', 'G', 'F', 'E'] as const).map((rank) => (
            <SaboTechBorder key={rank} variant="rank" rankLevel={rank} interactive>
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-semibold text-foreground">Pre-configured Components</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <SaboTechButton className="w-full">Full Width Button</SaboTechButton>
            </div>
          </div>
      ...
      {/* Integration Example */}
      <section className="space-y-6">
        <h2 className="text-2xl font-semibold text-foreground">Integration Example</h2>
