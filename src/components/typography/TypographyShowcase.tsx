...
export const TypographyShowcase: React.FC = () => {
  return (
    <div className="container mx-auto p-6 space-y-8">
      ...
      <Card className="p-6">
        <h2 className="heading-primary mb-4">1. Brand Typography - Bebas Neue</h2>
        <div className="space-y-4">
          <div>
            <h3 className="brand-logo">SABO ARENA</h3>
            <p className="body-small text-muted-foreground">Class: brand-logo</p>
          </div>
          <div>
            <h3 className="brand-title">Giải Đấu Thế Giới</h3>
            <p className="body-small text-muted-foreground">Class: brand-title</p>
          </div>
          <div>
            <h3 className="tournament-name">Tournament Premier League</h3>
            <p className="body-small text-muted-foreground">Class: tournament-name</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-6">
        <h2 className="heading-primary mb-4">2. Heading Typography - Epilogue</h2>
        <div className="space-y-4">
          <div>
            <h3 className="heading-primary">Heading Primary</h3>
            <p className="body-small text-muted-foreground">Class: heading-primary</p>
          </div>
          <div>
            <h4 className="heading-secondary">Heading Secondary</h4>
            <p className="body-small text-muted-foreground">Class: heading-secondary</p>
          </div>
          <div>
            <h5 className="heading-tertiary">Heading Tertiary</h5>
            <p className="body-small text-muted-foreground">Class: heading-tertiary</p>
          </div>
          <div>
            <h6 className="section-title">Section Title</h6>
            <p className="body-small text-muted-foreground">Class: section-title</p>
          </div>
          <div>
            <h6 className="card-title">Card Title</h6>
            <p className="body-small text-muted-foreground">Class: card-title</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="body-small text-muted-foreground">Class: body-large</p>
          </div>
          <div>
            <p className="body-medium">
              Body Medium - Lorem ipsum dolor sit amet, consectetur adipiscing elit.
            </p>
            <p className="body-small text-muted-foreground">Class: body-medium</p>
          </div>
          <div>
            <p className="body-small">
              Body Small - Lorem ipsum dolor sit amet.
            </p>
            <p className="body-small text-muted-foreground">Class: body-small</p>
          </div>
          <div>
            <p className="description">
              Description - This is a descriptive text with muted color.
            </p>
            <p className="body-small text-muted-foreground">Class: description</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-6">
        <h2 className="heading-primary mb-4">4. Stats Typography - Racing Sans One</h2>
        <div className="space-y-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="text-center p-4 bg-muted rounded-lg">
            <div className="stats-large text-primary">2450</div>
            <p className="body-small text-muted-foreground">ELO Score (stats-large)</p>
          </div>
          <div className="text-center p-4 bg-muted rounded-lg">
            <div className="stats-medium text-green-600">87.5%</div>
            <p className="body-small text-muted-foreground">Win Rate (stats-medium)</p>
          </div>
          <div className="text-center p-4 bg-muted rounded-lg">
            <div className="elo-score text-blue-600">1875</div>
            <p className="body-small text-muted-foreground">Current ELO (elo-score)</p>
          </div>
          <div className="text-center p-4 bg-muted rounded-lg">
            <div className="match-score text-orange-600">15-7</div>
            <p className="body-small text-muted-foreground">Match Score (match-score)</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="body-small text-muted-foreground">Class: text-responsive-xl</p>
          </div>
          <div>
            <p className="text-responsive-lg">Responsive Large Text</p>
            <p className="body-small text-muted-foreground">Class: text-responsive-lg</p>
          </div>
          <div>
            <p className="text-responsive-md">Responsive Medium Text</p>
            <p className="body-small text-muted-foreground">Class: text-responsive-md</p>
          </div>
          <div>
            <p className="text-responsive-sm">Responsive Small Text</p>
            <p className="body-small text-muted-foreground">Class: text-responsive-sm</p>
          </div>
          <div>
            <p className="text-responsive-xs">Responsive XS Text</p>
            <p className="body-small text-muted-foreground">Class: text-responsive-xs</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-6">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg mb-6">
          ...
          <p className="description mb-4">
            Giải đấu bi-a 8 bi lớn nhất trong năm với sự tham gia của các tay cơ hàng đầu 
            tại SABO ARENA. Cơ hội để thể hiện kỹ năng và giành được giải thưởng hấp dẫn.
          </p>
