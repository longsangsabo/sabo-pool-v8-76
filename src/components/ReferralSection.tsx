  ...
  return (
    <Card className="p-6">
      ...
      <div className="space-y-4">
        <div>
          <label className="text-sm text-muted-foreground">Mã giới thiệu của bạn</label>
        ...
        <Alert>
          ...
          <AlertDescription>
            <strong>Nhận 100 SPA</strong> khi bạn bè đăng ký và xác thực hạng thành công!
            Bạn bè cũng nhận 100 SPA khi đăng ký.
          </AlertDescription>
        </Alert>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="text-center p-4 bg-muted/50 rounded-lg">
            <div className="flex items-center justify-center gap-1 mb-1">
              ...
              <span className="text-2xl font-bold text-green-600">{stats?.totalEarned || 0}</span>
        ...
        {profile?.my_referral_code && (
          <div className="pt-2 border-t">
            <p className="text-xs text-muted-foreground text-center">
              Chia sẻ link: {window.location.origin}/auth/register?ref={profile.my_referral_code}
            </p>
          </div>
        )}
      </div>
