...
const ProductionReadyAppContent: React.FC<{ children: React.ReactNode }> = ({ children }) => {
            ...
            <Alert className="border-none bg-transparent p-2">
              ...
              <AlertDescription className="flex items-center gap-2 text-sm">
                <span>
                  ...
                  Device: <Badge variant="outline">{responsive.breakpoint}</Badge>
                </span>
                {isEnabled('experimentalLayouts') && (
                  <Badge variant="secondary">Experimental Features Active</Badge>
                )}
              </AlertDescription>
            </Alert>
          </div>
