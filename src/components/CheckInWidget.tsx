        ...
        {userStreak && (
          <div className="space-y-3">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-bold text-lg text-gray-900">{userStreak?.total_points || 0}</span>
            </div>
            ...
            <div className="text-xs text-gray-500">
              Còn {Math.max(0, 7 - (userStreak?.current_streak || 0))} ngày để lên 20 điểm/ngày
            </div>
          </div>
        )}
          ...
          <div className="space-y-2">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div 
                ...
                style={{ width: `${Math.min(100, ((userStreak?.current_streak || 0) / 30) * 100)}%` }}
              />
            </div>
