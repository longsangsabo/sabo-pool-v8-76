...
import { Bot, Send, MessageCircle, BarChart3, Users, TrendingUp } from 'lucide-react';
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'assistant',
      content: 'Xin chào! Tôi là trợ lý AI của hệ thống. Tôi có thể giúp bạn phân tích dữ liệu, tạo báo cáo và quản lý hệ thống. Bạn cần hỗ trợ gì?',
      timestamp: new Date()
    }
  ]);
  ...
  const quickActions = [
    {
      ...
      icon: Users,
      action: () => setQuery('Phân tích xu hướng người dùng đăng ký trong 30 ngày qua')
    },
    {
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      const response = {
        ...
        content: 'Tôi đang xử lý yêu cầu của bạn. Tính năng AI Assistant sẽ được hoàn thiện trong phiên bản tiếp theo.',
        timestamp: new Date()
      };
