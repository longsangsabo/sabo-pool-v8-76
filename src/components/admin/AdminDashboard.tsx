      ...
      <Tabs defaultValue="migration" className="space-y-4">
        ...
        <TabsContent value="tournaments">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">Tournament management tools will be available here.</p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="system">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">System configuration tools will be available here.</p>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
