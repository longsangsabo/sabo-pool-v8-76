...
import { AlertTriangle, Eye, MessageSquare, Clock, CheckCircle, XCircle } from 'lucide-react';
...
const MatchIncidentReporting: React.FC<MatchIncidentReportingProps> = ({ tournamentId }) => {
            ...
            <Dialog>
              ...
              <DialogContent>
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium mb-2">ID Trận đấu</label>
                    <Input
                      placeholder="Nhập ID trận đấu..."
                      value={newIncident.matchId}
                      onChange={(e) => setNewIncident({...newIncident, matchId: e.target.value})}
                    />
                  </div>
                  
                  <div>
                    <label className="block text-sm font-medium mb-2">Loại sự cố</label>
                    <Select value={newIncident.type} onValueChange={(value) => setNewIncident({...newIncident, type: value})}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="player_conduct">Hành vi người chơi</SelectItem>
                        <SelectItem value="rule_violation">Vi phạm luật chơi</SelectItem>
                        <SelectItem value="equipment_failure">Hỏng thiết bị</SelectItem>
                        <SelectItem value="venue_issue">Sự cố địa điểm</SelectItem>
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Mức độ nghiêm trọng</label>
                            ...
                            <div className="space-y-4">
                              ...
                              <div>
                                ...
                                <Select 
                                  ...
                                  onValueChange={(value) => handleUpdateIncidentStatus(selectedIncident.id, value)}
                                >
                                  <SelectTrigger>
                                    <SelectValue />
                                  </SelectTrigger>
