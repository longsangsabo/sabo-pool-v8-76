...
import { Search, Calendar, Users, DollarSign, Trophy, Eye, Edit, Trash2 } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Quản lý tất cả các giải đấu trong hệ thống</p>
        </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xl font-bold">
                  {formatCurrency(tournaments.reduce((sum, t) => sum + (t.prize_pool || 0), 0))}
                </p>
              </div>
            </div>
          </CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Danh sách Giải đấu ({filteredTournaments.length})</CardTitle>
        </CardHeader>
        <CardContent>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div>
                          <span className="text-muted-foreground">Số người tối đa:</span>
                        ...
                        <div>
                          ...
                          <p className="font-medium">{formatDate(tournament.created_at)}</p>
                        </div>
                      </div>
                      ...
                      {tournament.club_profiles && (
                        <div className="mt-2 text-sm">
                          ...
                          <span className="ml-1 font-medium">{tournament.club_profiles.club_name}</span>
                        </div>
                      )}
                    </div>
