...
import { Code, AlertTriangle, BarChart3, ExternalLink, Search, Keyboard, Users, Settings } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-green-200 bg-gradient-to-r from-green-50 to-emerald-50 animate-fade-in">
        <CardHeader>
          ...
          <CardDescription className="text-green-700">
            Tournament management moved to /admin/tournaments. Simplified dev tools with essential features only.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Alert>
        ...
        <AlertDescription>
          Tournament management has been moved to <strong>/admin/tournaments</strong> for better organization.
        </AlertDescription>
      </Alert>
