  ...
  const runEloSystemTests = () => {
    ...
    try {
      ...
      results.push({
        ...
        message: isAscending ? 'ELO values properly ascend by rank' : 'ELO values do not properly ascend',
    ...
    try {
      ...
      const failedConversions = conversions.filter(c => !c.rankMatches || !c.eloMatches);
    ...
    try {
      const allRanks = ['K', 'K+', 'I', 'I+', 'H', 'H+', 'G', 'G+', 'F', 'F+', 'E', 'E+'];
      ...
      const allCovered = conversionRanks.every(r => r.hasConstant && r.hasConversion);
      const missingRanks = conversionRanks.filter(r => !r.hasConstant || !r.hasConversion);
    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-4">
        <Alert>
          ...
          <AlertDescription>
            This validator checks the consistency and correctness of the ELO ranking system.
            It tests constants, conversions, boundaries, and coverage.
          </AlertDescription>
        </Alert>
        ...
        <Alert className="bg-blue-50 border-blue-200">
          ...
          <AlertDescription>
            ...
            <br />
            K: 1000, K+: 1100, I: 1200, I+: 1300, H: 1400, H+: 1500, 
            G: 1600, G+: 1700, F: 1800, F+: 1900, E: 2000, E+: 2100
          </AlertDescription>
        </Alert>
      </CardContent>
    </Card>
