      ...
      <CardContent>
                ...
                {ranks.map(rank => {
                  ...
                  return (
                    <div key={rank} className="border rounded-lg p-4">
                      ...
                      <div>
                        <h4 className="font-medium mb-2 text-sm">Yêu cầu kiểm tra:</h4>
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            <li>• Tất cả định nghĩa hạng được áp dụng thống nhất trên toàn hệ thống</li>
            <li>• CLB cần test kỹ lưỡng theo đúng yêu cầu của từng hạng</li>
            <li>• Xác thực sai sẽ ảnh hưởng đến uy tín của câu lạc bộ</li>
            <li>• Người chơi có thể thăng hạng dựa trên SPA points và rank points</li>
          </ul>
        </div>
      </CardContent>
    </Card>
