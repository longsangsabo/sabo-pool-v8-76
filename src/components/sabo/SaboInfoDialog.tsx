...
import { getAllRanks, getRankDisplayName, type SaboRank } from '@/utils/saboHandicap';
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="text-sm text-muted-foreground leading-relaxed">
              SABO Professional System là hệ thống thách đấu chuyên nghiệp với handicap tự động, 
              giúp tạo ra các trận đấu cân bằng và công bằng giữa các người chơi có trình độ khác nhau.
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-2">
                ...
                <span>Chỉ được thách đấu trong phạm vi <strong>±2 hạng chính</strong> (tương đương ±4 hạng phụ)</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="font-medium text-green-600">•</span>
                <span>Ví dụ: Hạng H có thể thách đấu từ Hạng F+ đến Hạng I+</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="font-medium text-green-600">•</span>
                <span>Hệ thống sẽ tự động kiểm tra tính hợp lệ của thách đấu</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3 text-sm">
              <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                <div className="font-medium text-blue-800 mb-2">Công thức cơ bản:</div>
                <div className="text-blue-700">
                  Handicap = min(Chênh lệch hạng, Mức cược ÷ (200 - Chênh lệch × 25))
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1">
                  <div><strong>Cùng hạng:</strong> Không có handicap</div>
                  <div><strong>Đối thủ hạng cao hơn:</strong> Bạn được cộng bàn</div>
                  <div><strong>Bạn hạng cao hơn:</strong> Đối thủ được cộng bàn</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid gap-3">
              <div className="p-3 bg-green-50 rounded-lg border border-green-200">
                <div className="font-medium text-green-800 mb-1">Trường hợp 1: Bạn được handicap</div>
              ...
              <div className="p-3 bg-orange-50 rounded-lg border border-orange-200">
                <div className="font-medium text-orange-800 mb-1">Trường hợp 2: Đối thủ được handicap</div>
