...
export const SemifinalSection: React.FC<SemifinalSectionProps> = ({
  ...
  const semifinalMatches = matches.filter(match => 
    (
      ...
      (match.match_stage === 'semifinal' || match.match_stage === 'semifinals')
    ) &&
        ...
        <div className="grid gap-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <Badge variant="outline" className="border-blue-300 text-blue-700">R250: Semifinals</Badge>
          ...
          <div className="mt-4 p-4 bg-blue-100 dark:bg-blue-900/30 rounded-lg border border-blue-200">
            <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">Semifinal Composition</h4>
