...
export const EnhancedMatchCard: React.FC<EnhancedMatchCardProps> = ({
  ...
  const getStatusBadge = () => {
    switch (match.status) {
      ...
      case 'ongoing':
        return <Badge variant="secondary"><Timer className="w-3 h-3 mr-1" />Đang diễn ra</Badge>;
      case 'scheduled':
        return <Badge variant="outline"><Users className="w-3 h-3 mr-1" />Đã lên lịch</Badge>;
      default:
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between p-2 rounded bg-blue-50">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-medium">
                {match.player1?.full_name || match.player1?.display_name || 'TBD'}
              </span>
          ...
          <div className="flex items-center justify-between p-2 rounded bg-red-50">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-medium">
                {match.player2?.full_name || match.player2?.display_name || 'TBD'}
              </span>
        ...
        {showAdvanced && match.winner_id && (
          <div className="mt-3 pt-2 border-t text-center">
            <Badge variant="outline" className="text-xs">
              ...
              Người thắng: {match.winner_id === match.player1_id 
