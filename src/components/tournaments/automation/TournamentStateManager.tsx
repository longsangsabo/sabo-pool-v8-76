...
import { Play, Pause, Square, Trophy, Users, Calendar, AlertTriangle } from 'lucide-react';
    ...
    switch (status) {
      ...
      case 'registration_closed':
        return {
          ...
          description: 'Registration period has ended, tournament ready to start'
        };
      case 'ongoing':
        return {
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div>
            ...
            <p className="font-medium capitalize">{tournament.tournament_type || 'Single Elimination'}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="font-medium">{tournament.current_participants || 0}</p>
          </div>
        </div>
        ...
        {isAdmin && availableTransitions.length > 0 && (
          <div className="space-y-3 pt-3 border-t">
            <h4 className="font-medium text-sm text-muted-foreground">Available Actions:</h4>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            {transition.description}. This action cannot be undone.
        ...
        {!isAdmin && (
          <div className="text-xs text-muted-foreground bg-gray-50 p-3 rounded-lg">
            <p>🔒 Only tournament administrators can change the tournament state.</p>
          </div>
        )}
      </CardContent>
    </Card>
