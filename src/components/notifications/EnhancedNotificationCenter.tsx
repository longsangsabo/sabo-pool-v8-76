...
const EnhancedNotificationCenter: React.FC = () => {
  ...
  const allNotifications = notifications.length > 0 ? notifications as Notification[] : mockNotifications;
          ...
          <div className="px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="text-center p-3 bg-blue-50 rounded-lg">
                <div className="text-xl font-bold text-blue-600">{allNotifications.length}</div>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="grid w-full grid-cols-3">
                ...
                <TabsTrigger value="important">
                  Quan trọng ({filteredNotifications.filter(n => n.priority === 'urgent' || n.priority === 'high').length})
                </TabsTrigger>
              </TabsList>
