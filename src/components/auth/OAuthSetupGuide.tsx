...
export const OAuthSetupGuide = () => {
  ...
  const redirectUrl = 'https://knxevbkkkiadgppxbphh.supabase.co/auth/v1/callback';
    ...
    <Card className="mt-4">
      ...
      <CardContent>
          ...
          <TabsContent value="supabase" className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <Button
                variant="outline"
                size="sm"
                onClick={() => window.open('https://supabase.com/dashboard/project/f5355f18-6802-404b-9d2c-539e6dccb10c/auth/providers', '_blank')}
              ...
              <div className="bg-gray-50 p-3 rounded space-y-2">
                <div className="flex items-center gap-2">
                  <code className="bg-white px-2 py-1 rounded text-sm flex-1">Site URL: {siteUrl}</code>
                  <Button 
                    size="sm" 
                    variant="ghost"
                ...
                <div className="flex items-center gap-2">
                  <code className="bg-white px-2 py-1 rounded text-sm flex-1">Redirect URL: {redirectUrl}</code>
                  <Button 
                    size="sm" 
                    variant="ghost"
          ...
          <TabsContent value="google" className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-gray-50 p-3 rounded space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <code className="bg-white px-2 py-1 rounded text-sm flex-1">{siteUrl}</code>
                  <Button 
                    size="sm" 
                    variant="ghost"
                    onClick={() => copyToClipboard(siteUrl, 'JavaScript origin')}
                  >
                    <Copy className="h-4 w-4" />
                  </Button>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <code className="bg-white px-2 py-1 rounded text-sm flex-1">{redirectUrl}</code>
                  <Button 
                    size="sm" 
                    variant="ghost"
              ...
              <p>7. Copy Client ID và Client Secret, thêm vào Supabase Dashboard</p>
            </div>
          </TabsContent>
              ...
              <div className="bg-gray-50 p-3 rounded space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button 
                    size="sm" 
                    variant="ghost"
                    onClick={() => copyToClipboard(redirectUrl, 'OAuth Redirect URI')}
                  >
                    <Copy className="h-4 w-4" />
                  </Button>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <code className="bg-white px-2 py-1 rounded text-sm flex-1">knxevbkkkiadgppxbphh.supabase.co</code>
                  <Button 
                    size="sm" 
                    variant="ghost"
                    onClick={() => copyToClipboard('knxevbkkkiadgppxbphh.supabase.co', 'App Domain')}
                  >
                    <Copy className="h-4 w-4" />
                  </Button>
                </div>
        ...
        <Alert className="mt-4">
          <AlertDescription>
            <strong>💡 Lưu ý:</strong> Sau khi cấu hình xong, có thể mất vài phút để các thay đổi có hiệu lực. 
            Nếu vẫn lỗi, hãy kiểm tra lại các URL và thông tin cấu hình.
          </AlertDescription>
        </Alert>
      </CardContent>
    </Card>
