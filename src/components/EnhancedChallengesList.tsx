...
const EnhancedChallengesList = () => {
  ...
  const handleChallengeResponse = async (
    ...
    try {
      ...
      console.log('Challenge response:', { challengeId: selectedChallenge?.id, status });
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    <Avatar className="w-10 h-10">
                      <AvatarImage 
                        src={challenge.challenger_profile?.avatar_url || challenge.opponent_profile?.avatar_url} 
                      />
                      <AvatarFallback>
                        {(challenge.challenger_profile?.full_name || challenge.opponent_profile?.full_name || 'U')[0]}
                      </AvatarFallback>
                    </Avatar>
                    <div>
