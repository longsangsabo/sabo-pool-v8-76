      ...
      <Card>
        <CardContent className="pt-6">
          <div className="flex items-center justify-center py-4">
            ...
            <span className="ml-2 text-sm text-muted-foreground">Đang tải điểm tin cậy...</span>
          </div>
        </CardContent>
      </Card>
    );
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Điểm tin cậy CLB</CardTitle>
          ...
          <CardContent>
            ...
            <Badge variant={getTrustBadgeVariant(data.clubTrustScore)} className="mt-2">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Điểm tin cậy TB</CardTitle>
        ...
        <CardContent>
          {data.memberTrustScores.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">Chưa có thành viên nào được xác thực</p>
            </div>
          ) : (
                ...
                .map((member) => (
                  <div key={member.user_id} className="flex items-center justify-between p-3 border rounded-lg">
                    ...
                    <div className="text-right">
                      ...
                      <Badge variant={getTrustBadgeVariant(member.trust_score)} className="text-xs">
