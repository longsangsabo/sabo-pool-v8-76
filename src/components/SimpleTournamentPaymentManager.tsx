            ...
            {selectedTournamentData && (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-muted/50 rounded-lg">
                <div className="text-center">
                  ...
                  <Badge variant="secondary">{selectedTournamentData.status}</Badge>
                </div>
                <div className="text-center">
                  <Users className="h-6 w-6 mx-auto mb-1 text-blue-500" />
                  <p className="text-sm text-muted-foreground">Tối đa</p>
                  <p className="font-semibold">{selectedTournamentData.max_participants}</p>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <p className="font-semibold">{selectedTournamentData.prize_pool?.toLocaleString()}đ</p>
                </div>
              </div>
            )}
          </div>
