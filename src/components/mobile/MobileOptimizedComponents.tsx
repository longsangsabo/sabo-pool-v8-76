...
export const MobileTouchButton: React.FC<{
  ...
  const baseClasses = 'mobile-touch-button transition-all duration-200 font-semibold rounded-xl';
...
export const MobileCard: React.FC<{
  ...
  return (
    <div className={cn(
      ...
      interactive && isMobile && 'active:scale-[0.98] transition-transform duration-200',
      className
    )}>
      {children}
    </div>
...
export const MobileList: React.FC<{
  ...
  return (
    <div className={cn('mobile-list', spacingClasses[spacing])}>
      {children}
    </div>
  );
};
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isMobile && onClick && 'active:scale-[0.98] transition-transform duration-200',
        className
      )}
    >
      {children}
