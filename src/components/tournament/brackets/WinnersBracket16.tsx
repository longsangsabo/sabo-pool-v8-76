    ...
    <div className="winners-bracket-grid grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="round round-1">
        <div className="mb-4">
          ...
          <p className="text-sm text-muted-foreground text-center">{round1Matches.length} matches</p>
        </div>
      ...
      <div className="round round-2">
        <div className="mb-4">
          ...
          <p className="text-sm text-muted-foreground text-center">{round2Matches.length} matches</p>
        </div>
      ...
      <div className="round round-3">
        <div className="mb-4">
          ...
          <p className="text-sm text-muted-foreground text-center">{round3Matches.length} matches</p>
        </div>
