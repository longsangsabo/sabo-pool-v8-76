  ...
  return (
    <div className="space-y-8">
          ...
          {maxParticipants && (
            <div className="bg-primary/10 rounded-lg p-3 text-sm">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Số vòng đấu loại trực tiếp: {Math.ceil(Math.log2(maxParticipants))} vòng
              </p>
            </div>
          )}
        </div>
      ...
      <div className="form-section bg-gradient-to-r from-background to-purple-50 rounded-lg p-6 border border-purple-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-3">
            ...
            <Select
              ...
              onValueChange={(value) => {
                ...
                console.log('🔥 After setValue, form tournament_type:', form.getValues('tournament_type'));
              }}
            >
              <SelectTrigger className={`h-12 ${errors.tournament_type ? 'border-destructive focus:border-destructive' : 'focus:border-purple-500'} transition-colors`}>
          ...
          <div className="space-y-3">
            ...
            >
              <SelectTrigger className={`h-12 ${errors.game_format ? 'border-destructive focus:border-destructive' : 'focus:border-purple-500'} transition-colors`}>
      ...
      <div className="form-section bg-gradient-to-r from-background to-green-50 rounded-lg p-6 border border-green-200">
        ...
        <div className="space-y-4">
          <div className="space-y-3">
            <Label htmlFor="entry_fee" className="text-sm font-semibold flex items-center gap-2">
              <div className="w-2 h-2 bg-destructive rounded-full"></div>
              Phí đăng ký (VNĐ)
            </Label>
            <Input
            ...
            <div className="bg-green-100 rounded-lg p-4 border border-green-200">
              <div className="text-sm space-y-2">
                ...
                <div className="text-green-700">
                  {suggestedFees.min.toLocaleString('vi-VN')}đ - {suggestedFees.max.toLocaleString('vi-VN')}đ
                </div>
      ...
      <div className="form-section bg-gradient-to-r from-background to-yellow-50 rounded-lg p-6 border border-yellow-200">
        ...
        <div className="space-y-6">
          <div className="space-y-3">
            <Label htmlFor="prize_pool" className="text-sm font-semibold flex items-center gap-2">
              <div className="w-2 h-2 bg-destructive rounded-full"></div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-lg p-4 text-center text-white">
                    ...
                    <div className="text-xs font-medium mt-1">Vô địch (50%)</div>
                    <div className="text-lg font-bold mt-2">{prizeDistribution.first.toLocaleString('vi-VN')}đ</div>
                  </div>
                  <div className="bg-gradient-to-r from-gray-300 to-gray-400 rounded-lg p-4 text-center text-white">
                    ...
                    <div className="text-lg font-bold mt-2">{prizeDistribution.second.toLocaleString('vi-VN')}đ</div>
                  </div>
                  <div className="bg-gradient-to-r from-amber-600 to-amber-700 rounded-lg p-4 text-center text-white">
                    <div className="text-2xl font-bold">🥉</div>
                    <div className="text-xs font-medium mt-1">Hạng ba (20%)</div>
                    <div className="text-lg font-bold mt-2">{prizeDistribution.third.toLocaleString('vi-VN')}đ</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="bg-gradient-to-r from-muted/50 to-muted/30 rounded-lg p-4 border border-muted">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between items-center">
                  <span className="text-muted-foreground">Tổng thu từ phí đăng ký:</span>
                ...
                <div className="border-t border-muted/50 pt-2 mt-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`font-bold text-lg ${maxParticipants * entryFee - prizePool >= 0 ? 'text-green-600' : 'text-red-600'}`}>
