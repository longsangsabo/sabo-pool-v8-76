            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p>Tính năng quản lý người tham gia sẽ được triển khai sớm</p>
                  <p className="text-sm">Hiện tại có {selectedTournament.current_participants} người đăng ký</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p>Tính năng quản lý trận đấu chi tiết sẽ được triển khai sớm</p>
                  <p className="text-sm">Hiện tại có {existingMatches.length} trận đấu trong giải</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
