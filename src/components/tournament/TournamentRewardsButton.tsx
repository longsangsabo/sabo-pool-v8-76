        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="grid gap-4">
              {[
                { position: 1, name: 'Vô địch', eloPoints: championRewards.eloPoints, spaPoints: championRewards.spaPoints, icon: <Trophy className="w-5 h-5 text-yellow-500" /> },
                { position: 2, name: 'Á quân', eloPoints: Math.round(championRewards.eloPoints * 0.6), spaPoints: Math.round(championRewards.spaPoints * 0.8), icon: <Medal className="w-5 h-5 text-gray-400" /> },
                { position: 3, name: 'Hạng ba', eloPoints: Math.round(championRewards.eloPoints * 0.4), spaPoints: Math.round(championRewards.spaPoints * 0.6), icon: <Award className="w-5 h-5 text-amber-600" /> },
                { position: 8, name: 'Top 8', eloPoints: top8Rewards.eloPoints, spaPoints: top8Rewards.spaPoints, icon: <Star className="w-5 h-5 text-blue-500" /> }
              ].map((reward) => (
