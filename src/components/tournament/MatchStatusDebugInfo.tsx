...
export const MatchStatusDebugInfo: React.FC<MatchStatusDebugInfoProps> = ({
  ...
  const getStatusInfo = () => {
    ...
    const isMatchReady = match.status === 'scheduled' && 
      hasPlayers && 
      playersAreDifferent &&
      !hasWinner;
  ...
  return (
    <div className="mt-2 p-2 bg-gray-50 rounded border text-xs space-y-1">
      <div className="font-medium text-gray-700">🔍 Debug Info (Club Owner Only)</div>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className={statusInfo.hasPlayers ? 'text-green-600' : 'text-red-600'}>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className={statusInfo.playersAreDifferent ? 'text-green-600' : 'text-red-600'}>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className={!statusInfo.hasWinner ? 'text-green-600' : 'text-yellow-600'}>
