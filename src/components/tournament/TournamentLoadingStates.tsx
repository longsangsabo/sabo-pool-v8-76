    ...
    {[1, 2, 3].map((round) => (
      <Card key={round}>
        ...
        <CardContent className="space-y-3">
          {[1, 2].map((match) => (
            <div key={match} className="flex items-center justify-between p-3 border rounded">
...
export const TournamentErrorDisplay: React.FC<TournamentErrorDisplayProps> = ({ error, onRetry }) => (
