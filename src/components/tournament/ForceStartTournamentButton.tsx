...
const ForceStartTournamentButton: React.FC<ForceStartTournamentButtonProps> = ({
  ...
  const canForceStart = ['registration_closed', 'upcoming'].includes(currentStatus);
  ...
  if (!canForceStart) {
    console.log('🔥 ForceStartTournamentButton: Not showing because status is', currentStatus);
    return null;
  }
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="space-y-3">
            <p>
              Bạn có chắc chắn muốn bắt đầu giải đấu <strong>"{tournamentName}"</strong> ngay bây giờ?
            </p>
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm text-orange-800">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-xs">
                    <li>Thời gian bắt đầu giải đấu sẽ được cập nhật thành hiện tại</li>
