  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-1">
              <Label htmlFor="tournament_start" className="text-xs font-medium flex items-center gap-1">
              ...
              {errors.tournament_start && (
                <p className="text-xs text-destructive">{String(errors.tournament_start.message)}</p>
              )}
            </div>

            <div className="space-y-1">
              <Label htmlFor="tournament_end" className="text-xs font-medium flex items-center gap-1">
                <Calendar className="h-3 w-3 text-blue-600" />
                <span className="w-1 h-1 bg-destructive rounded-full"></span>
                Kết thúc
              </Label>
              ...
              {errors.tournament_end && (
                <p className="text-xs text-destructive">{String(errors.tournament_end.message)}</p>
              )}
            </div>
          </div>
          ...
          <div className="space-y-1">
            <Label htmlFor="venue_address" className="text-xs font-medium flex items-center gap-1">
            ...
            {errors.venue_address && (
              <p className="text-xs text-destructive">{String(errors.venue_address.message)}</p>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        />
        {errors.tier_level && (
          <p className="text-xs text-destructive">{String(errors.tier_level.message)}</p>
        )}
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="flex gap-2 pt-4">
            <Button
              ...
              disabled={isUpdating || !newAddress.trim() || !newDistrict || !newCity}
              className="flex-1"
            >
