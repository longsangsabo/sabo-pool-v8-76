...
- Người chơi phải có mặt khi nhận giải`;
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-1">
        <Label htmlFor="contact_info" className="text-xs font-medium flex items-center gap-2">
      ...
      <div className="space-y-1">
        <div className="flex items-center justify-between">
          <Label htmlFor="rules" className="text-xs font-medium flex items-center gap-2">
      ...
      <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="requires_approval" className="text-xs cursor-pointer">
              Phê duyệt đăng ký
            </Label>
          </div>
        </div>
