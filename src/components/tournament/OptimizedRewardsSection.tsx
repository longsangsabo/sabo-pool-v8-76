...
export const OptimizedRewardsSection: React.FC<OptimizedRewardsSectionProps> = ({
  ...
  const getPositionColor = (position: number) => {
    switch (position) {
      ...
      default: return 'bg-gradient-to-r from-muted/30 to-muted/50 border-border';
    }
  };
    ...
    <>
      <Card className="mb-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <CardTitle className="text-lg">
                {showAsTemplate ? 'Template Phần Thưởng' : 'Phần Thưởng Giải Đấu'}
              </CardTitle>
        ...
        <CardContent className="space-y-4">
          ...
          {/* Special Awards */}
          {rewards_state.specialAwards && rewards_state.specialAwards.length > 0 && (
            ...
            <div className="pt-4 border-t">
              <div className="bg-muted/50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <div className="text-muted-foreground">Tổng thu từ phí tham gia</div>
                  ...
                  <div>
                    <div className="text-muted-foreground">Tổng giải thưởng</div>
                  ...
                  <div className="col-span-2 pt-2 border-t border-border/50">
                    <div className="text-muted-foreground">Lợi nhuận ước tính</div>
                    <div className={`font-medium ${
                      (maxParticipants * entryFee - rewards_state.totalPrize) >= 0 
                        ? 'text-green-600' 
                        : 'text-red-600'
                    }`}>
                      {formatPrizeAmount(maxParticipants * entryFee - rewards_state.totalPrize)}
                    </div>
                  </div>
                </div>
              </div>
