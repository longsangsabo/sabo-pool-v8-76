    ...
    <div className="space-y-4">
      <div className="bg-secondary/50 p-4 rounded-lg border">
        ...
        <p className="text-sm text-muted-foreground mb-4">
          Sử dụng chức năng này khi hệ thống tự động không hoạt động. 
          Chức năng sẽ tính toán kết quả dựa trên trận chung kết đã hoàn thành.
        </p>
            ...
            {lastResult.success ? (
              <div className="space-y-2">
                ...
                <div className="text-sm text-green-700">
                  <p>• Đã tạo kết quả cho {lastResult.results_created} người tham gia</p>
