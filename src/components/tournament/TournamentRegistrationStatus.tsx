...
export const TournamentRegistrationStatus: React.FC<TournamentRegistrationStatusProps> = ({
  tournament,
  onViewDetails,
  compact = false
}) => {
  ...
  const getReasonIcon = (reason: string) => {
    ...
    if (reason.includes('hạng') || reason.includes('tuổi')) return <Ban className="w-4 h-4" />;
