...
import { Calendar, MapPin, Users, Trophy, Coins, Clock, User } from 'lucide-react';
...
export const TournamentRegistrationConfirmModal: React.FC<TournamentRegistrationConfirmModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  tournament,
              ...
              <div className="space-y-4">
                <div className="flex items-start justify-between">
                  ...
                  <Badge className={getTierColor(tournament.status)}>
                    {tournament.status === 'registration_open' ? 'Đang mở đăng ký' : 'Sắp diễn ra'}
                  </Badge>
                </div>
              ...
              <Card className="bg-blue-50 border-blue-200">
                <CardContent className="pt-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <div className="font-semibold text-blue-800">Phí đăng ký</div>
              ...
              <Card className="bg-yellow-50 border-yellow-200">
                <CardContent className="pt-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <div className="font-semibold text-yellow-800">Tổng giải thưởng</div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm">
                ...
                <ul className="text-blue-700 space-y-1">
                  <li>• Bạn sẽ được xác nhận tham gia sau khi thanh toán phí đăng ký</li>
