      ...
      <CardContent className="p-4">
        ...
        <div className="grid grid-cols-5 gap-3 items-center mb-4">
          ...
          <div className="col-span-2 text-center">
            ...
            <div className="text-sm font-semibold truncate">{match.player1.name}</div>
            <div className="text-xs text-muted-foreground">{match.player1.rank}</div>
          </div>
          ...
          <div className="col-span-2 text-center">
            ...
            <div className="text-sm font-semibold truncate">{match.player2.name}</div>
            <div className="text-xs text-muted-foreground">{match.player2.rank}</div>
          </div>
        </div>
        ...
        <div className="space-y-2 mb-4">
          <div className="flex items-center gap-2">
            <div className="text-xs font-medium w-20 truncate">{match.player1.name}</div>
          ...
          <div className="flex items-center gap-2">
            <div className="text-xs font-medium w-20 truncate">{match.player2.name}</div>
            <div className="flex-1 bg-gray-200 rounded-full h-2">
              <div 
        ...
        <div className="flex items-center justify-between text-xs text-muted-foreground">
          <div className="flex items-center gap-1">
            ...
            <span>Bắt đầu: {new Date(match.startTime).toLocaleTimeString('vi-VN')}</span>
          </div>
          {match.location && (
            <div className="flex items-center gap-1">
