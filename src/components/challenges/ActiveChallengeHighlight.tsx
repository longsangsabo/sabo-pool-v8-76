...
import { Trophy, Target, Clock, DollarSign, Zap, ArrowRight } from 'lucide-react';
...
export const ActiveChallengeHighlight: React.FC<ActiveChallengeHighlightProps> = ({
  challenges,
  user,
  onChallengeClick
}) => {
  ...
  return (
    <>
      <Card className={`${hasActiveChallenges 
        ...
        <CardHeader className="pb-4">
          <CardTitle className={`flex items-center gap-3 ${hasActiveChallenges ? 'text-green-800' : 'text-gray-700'}`}>
            ...
            <div>
              <h3 className="text-xl font-bold">
                {hasActiveChallenges ? 'Thách đấu đang chờ thi đấu' : 'Khu vực thi đấu'}
              </h3>
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="font-semibold text-gray-800">{challenger.name}</div>
                            <div className="text-xs text-gray-500">{challenger.spa} SPA</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                          <div className="text-right">
                            ...
                            <div className="text-xs text-gray-500">{opponent.spa} SPA</div>
                          </div>
