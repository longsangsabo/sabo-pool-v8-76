...
export const ClubMobileDrawer: React.FC<ClubMobileDrawerProps> = ({ isOpen, onClose, clubProfile }) => {
    ...
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute left-0 top-0 h-full w-80 bg-card shadow-lg">
        <div className="p-4 border-b border-border">
          ...
          {clubProfile && (
            <p className="text-sm text-muted-foreground mt-1">{clubProfile.club_name}</p>
          )}
        </div>
