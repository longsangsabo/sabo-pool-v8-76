...
import { Trophy, Plus, CreditCard, Table, Network, GitBranch, Workflow, Award, Settings, Zap } from 'lucide-react';

// Import components
import TournamentManagementHub, { TournamentManagementHubRef } from '@/components/tournament/TournamentManagementHub';
...
import { TournamentStateProvider, useTournamentState } from '@/contexts/TournamentStateContext';
...
const ClubTournamentManagementInternal: React.FC = () => {
  ...
  const handleTournamentSuccess = (tournament: any) => {
    ...
    setTimeout(() => {
      ...
      if (tournament?.tournament_type === 'double_elimination') {
        toast.info('Giải đấu đã được tạo! Vào "Quản lý Bảng đấu" để tạo bảng đấu loại kép');
      }
    }, 500);
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        <Tabs value={managementActiveTab} onValueChange={setManagementActiveTab} className="space-y-4">
          <TabsList className="grid w-full grid-cols-3 lg:grid-cols-5">
            ...
            <TabsTrigger value="bracket-view" className="flex items-center gap-2">
          ...
          <TabsContent value="create">
            <ProfileProvider>
              <TournamentProvider>
                {(() => {
                  console.log('🎯 About to render EnhancedTournamentForm inside providers');
                  return (
            ...
            <div className="space-y-6">
              ...
              {!selectedTournamentId && (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-2">Chọn giải đấu</h3>
                  <p className="text-muted-foreground">
                ...
                <Card className="border-dashed border-orange-200 bg-orange-50/50">
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-semibold text-orange-800">🧪 Development Test</h3>
                        <p className="text-sm text-orange-600">Test complete tournament flow: scores → advancement → completion</p>
                      </div>
                      <Button 
        ...
        <TabsContent value="results">
            <div className="space-y-6">
              ...
              {selectedTournamentId && selectedTournament?.status === 'completed' && (
...
const ClubTournamentManagement: React.FC<ClubTournamentManagementProps> = ({ clubId }) => {
