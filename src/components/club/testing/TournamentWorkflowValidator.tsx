...
export const TournamentWorkflowValidator: React.FC<{ clubId: string }> = ({ clubId }) => {
  return (
    <Card>
      <CardHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border rounded-lg">
              <h4 className="font-medium text-green-600 mb-2">✅ Active Features</h4>
            ...
            <div className="p-4 border rounded-lg">
              <h4 className="font-medium text-blue-600 mb-2">🔧 Available Tools</h4>
              <ul className="text-sm space-y-1">
