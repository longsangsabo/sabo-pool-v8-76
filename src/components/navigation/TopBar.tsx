        ...
        <div className="flex items-center">
          <Link to="/" className="flex items-center space-x-3">
            ...
            <div className="hidden sm:flex flex-col">
              ...
              <span className="text-sm text-primary font-bold -mt-1">ARENA</span>
            </div>
          </Link>
        </div>
        ...
        <div className="flex items-center space-x-3">
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                {userRole === 'club' && (
                  <>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem asChild>
                      <Link to="/club-management" className="flex items-center text-purple-600">
          ...
          {showAuthButtons && !user && (
            <div className="flex items-center space-x-2">
              ...
              <Link to="/register">
                <Button size="sm" className="bg-gradient-to-r from-primary to-primary-glow hover:from-primary/90 hover:to-primary-glow/90">
                  Đăng ký
                </Button>
              </Link>
            </div>
