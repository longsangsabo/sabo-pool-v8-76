        ...
        <div className="space-y-4">
          ...
          {isCompleted && hasWinner && (
            <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-bold text-green-700">Tournament Champion</span>
              </div>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="mt-4 p-3 bg-gold-100 dark:bg-gold-900/30 rounded-lg border border-gold-200">
            <p className="text-xs text-muted-foreground">
              <strong>Grand Final:</strong> The two semifinal winners compete for the championship. 
              This is the culmination of the entire SABO tournament structure.
            </p>
          </div>
          ...
          {isCompleted && (
            <div className="mt-4 p-3 bg-muted rounded-lg">
              ...
              <div className="text-xs text-muted-foreground space-y-1">
                <p>• Started with 16 players across Winners and Losers brackets</p>
                <p>• Completed 27 total matches in SABO structure</p>
                <p>• Every player had opportunities for advancement</p>
                <p>• Champion emerged through competitive bracket progression</p>
              </div>
            </div>
          )}
        </div>
