...
export const SABOMatchCard: React.FC<SABOMatchCardProps> = ({
  ...
  const canManageScore = !isCompleted && (
    isClubOwner || 
    (hasPlayers && (match.player1_id === currentUserId || match.player2_id === currentUserId))
  );
    ...
    switch (variant) {
      ...
      case 'gold':
        return {
          ...
          background: 'bg-gradient-to-r from-yellow-50 to-orange-100 dark:from-yellow-950/30 dark:to-orange-900/30',
        ...
        {isCompleted ? (
            ...
            <div className={cn(
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className={cn(
                    "font-semibold",
                    isPlayer1Winner ? "text-green-700 dark:text-green-400" : "text-gray-600 dark:text-gray-400"
                  )}>
                    {player1?.display_name || 'Player 1'}
                  </div>
                  {isPlayer1Winner && (
                    <div className="text-xs text-green-600 dark:text-green-400 font-medium">WINNER</div>
                  )}
              ...
              <div className={cn(
                "text-3xl font-bold",
                isPlayer1Winner ? "text-green-600 dark:text-green-400" : "text-gray-500 dark:text-gray-400"
              )}>
            ...
            <div className={cn(
              ...
              <div className="flex items-center space-x-3">
                ...
                <Avatar className="h-10 w-10">
                  ...
                  <AvatarFallback>{player2?.display_name?.[0] || '?'}</AvatarFallback>
                </Avatar>
                <div>
                  <div className={cn(
                    "font-semibold",
                    isPlayer2Winner ? "text-green-700 dark:text-green-400" : "text-gray-600 dark:text-gray-400"
                  )}>
              ...
              <div className={cn(
                "text-3xl font-bold",
                isPlayer2Winner ? "text-green-600 dark:text-green-400" : "text-gray-500 dark:text-gray-400"
              )}>
          ...
          <div className="space-y-3">
            ...
            <div className={cn(
              ...
              winner_id === player1?.user_id && highlightWinner ? "bg-green-100 dark:bg-green-900/20 border border-green-200" : "bg-white dark:bg-gray-800/50"
            )}>
              <div className="flex items-center gap-2">
            ...
            <div className={cn(
              "flex items-center justify-between p-2 rounded-lg",
              winner_id === player2?.user_id && highlightWinner ? "bg-green-100 dark:bg-green-900/20 border border-green-200" : "bg-white dark:bg-gray-800/50"
            )}>
              <div className="flex items-center gap-2">
                <Avatar className="h-8 w-8">
                  <AvatarImage src={player2?.avatar_url} />
