...
export const SABOMatchSummary: React.FC<SABOMatchSummaryProps> = ({ match }) => {
  const { player1, player2, winner_id, player1_score = 0, player2_score = 0 } = match;
      ...
      <div className="flex items-center justify-center space-x-4">
        <div className={cn(
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            <div className="font-semibold">{player1?.display_name || 'Player 1'}</div>
          </div>
          <div className="text-3xl font-bold">{player1_score}</div>
        </div>
        
        <div className="text-gray-400 dark:text-gray-600 text-xl font-bold">-</div>
        ...
        <div className={cn(
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            <div className="font-semibold">{player2?.display_name || 'Player 2'}</div>
          </div>
