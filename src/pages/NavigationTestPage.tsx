      ...
      <div className='container mx-auto p-6 space-y-8'>
        ...
        <div className='text-center space-y-4'>
          ...
          <p className='text-lg text-muted-foreground'>
            Testing the new unified navigation system across all roles and
            devices
          </p>
        ...
        <Card className='border-primary'>
          ...
          <CardContent>
            <div className='space-y-3 text-sm'>
              <div>
                1. <strong>Resize browser window</strong> to see responsive
                behavior
              </div>
              <div>
                2. <strong>Check mobile view</strong> (&lt; 768px) - Should show
                bottom navigation
              </div>
              <div>
                3. <strong>Check desktop view</strong> (≥ 1024px) - Should show
                sidebar
              </div>
              <div>
                4. <strong>Navigate between pages</strong> - Active states
                should work
              </div>
              <div>
                5. <strong>Test user roles</strong> - Different navigation items
                per role
              </div>
              <div>
                6. <strong>Check badges</strong> - Notification/challenge counts
              </div>
            </div>
          </CardContent>
        </Card>
