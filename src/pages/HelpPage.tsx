...
const HelpPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Điểm SPA (SABO ARENA) là hệ thống xếp hạng của chúng tôi. Bạn được điểm khi thắng thách đấu, tham gia giải đấu, và check-in hàng ngày. Điểm cao hơn = hạng cao hơn.'
    },
    {
