...
import { Search, Eye, Settings, Users, Trophy, Clock, MapPin, DollarSign, UserPlus, Zap, Trash2 } from 'lucide-react';
...
const AdminTournaments: React.FC = () => {
  ...
  const { deleteTournament, isLoading: tournamentUtilsLoading } = useTournamentUtils();
          ...
          <Card key={tournament.id} className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium">
                  {tournament.entry_fee === 0 ? 'Miễn phí' : formatCurrency(tournament.entry_fee)}
                </span>
              </div>
