  ...
  const columns = useMemo(() => [
    ...
    },
    {
      ...
      render: (value: string) => {
        const roleConfig = {
          ...
          moderator: { label: 'Mod', color: 'bg-blue-100 text-blue-800', icon: Shield },
          player: { label: 'Player', color: 'bg-gray-100 text-gray-800', icon: User }
        };
        
        const config = roleConfig[value as keyof typeof roleConfig] || roleConfig.player;
    ...
    },
    {
      ...
      render: (value: string) => {
        ...
        const config = membershipConfig[value as keyof typeof membershipConfig] || membershipConfig.basic;
    ...
    },
    {
      ...
      render: (value: string) => {
        ...
        return (
          <Badge className={skillColors[value as keyof typeof skillColors] || skillColors.beginner}>
            {value || 'N/A'}
          </Badge>
        );
      }
      ...
      <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Quản lý thông tin và quyền hạn của {totalCount.toLocaleString()} người dùng
          </p>
        </div>
      </div>
