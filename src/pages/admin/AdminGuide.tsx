  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Tài Liệu Hướng Dẫn</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Video Hướng Dẫn</CardTitle>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">Công cụ quản lý tài liệu và video hướng dẫn sẽ hiển thị ở đây.</p>
        </CardContent>
      </Card>
    </div>
  );
