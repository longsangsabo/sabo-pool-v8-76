  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Hỗ Trợ Khẩn Cấp</CardTitle>
      ...
      <Card className="border-destructive">
        <CardHeader>
          <CardTitle className="text-destructive">Tình Huống Khẩn Cấp</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground">Các tình huống khẩn cấp và hành động cần thiết sẽ hiển thị ở đây.</p>
        </CardContent>
      </Card>
    </div>
  );
