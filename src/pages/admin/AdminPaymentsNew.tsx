...
interface Payment {
  ...
  userName: string;
  userAvatar?: string;
  type: 'deposit' | 'withdrawal' | 'wager_win' | 'wager_loss' | 'tournament_fee' | 'refund' | 'bonus';
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-4">
                  {filteredPayments.map((payment) => (
                    <Card key={payment.id} className={`cursor-pointer transition-all hover:shadow-md ${
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-start justify-between">
                            <div className="space-y-2">
                              <div className="flex items-center gap-2">
                                <h3 className="font-medium">{payment.transactionId}</h3>
                                {!payment.isAutomated && (
                          ...
                          <div className="flex items-center gap-4 text-sm">
                            <div className="flex items-center gap-1">
                              <Badge className={getTypeColor(payment.type)}>
                                ...
                                <span className="ml-1">{payment.type.replace('_', ' ')}</span>
                              </Badge>
                            </div>
                            <div className="flex items-center gap-1">
                  ...
                  {selectedPayment ? (
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="space-y-2">
                              <div className="flex justify-between">
                                ...
                                <span className="text-sm">{selectedPayment.createdAt.toLocaleString()}</span>
                              </div>
                              {selectedPayment.processedAt && (
                                <div className="flex justify-between">
                                  <span className="text-sm">Processed:</span>
                                  <span className="text-sm">{selectedPayment.processedAt.toLocaleString()}</span>
                                </div>
                              )}
                    ...
                    <Card>
                      <CardContent className="p-12 text-center">
                        ...
                        <p className="text-muted-foreground">
                          Choose a payment transaction to view details and take action.
                        </p>
                      </CardContent>
                    </Card>
                  )}
                    ...
                    <CardContent className="space-y-4">
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          ...
                          <span className="text-sm font-medium">{gateway.successRate}%</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-sm">Avg Processing:</span>
                          <span className="text-sm">{gateway.avgProcessingTime}s</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-sm">Daily Usage:</span>
                          <span className="text-sm">
                            {((gateway.usedToday / gateway.dailyLimit) * 100).toFixed(1)}%
                          </span>
                        </div>
                        <Progress 
                        ...
                        />
                        <div className="text-xs text-muted-foreground">
                          {gateway.usedToday.toLocaleString()}đ / {gateway.dailyLimit.toLocaleString()}đ
                        </div>
                      </div>
                      ...
                      <div>
                        <div className="text-sm font-medium mb-2">Supported Methods:</div>
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">
                          Fixed: {gateway.fees.fixed.toLocaleString()}đ + {gateway.fees.percentage}%
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <div className="space-y-4">
                      {analytics.topMethods.map((method, index) => (
                        <div key={index} className="space-y-2">
                          ...
                          <Progress 
                            value={(method.volume / analytics.totalVolume) * 100} 
                            className="h-2" 
                          />
                          <div className="text-xs text-muted-foreground">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground">
                      Payment gateway settings and configuration options will be available here.
                    </p>
                  </div>
                </CardContent>
              </Card>
