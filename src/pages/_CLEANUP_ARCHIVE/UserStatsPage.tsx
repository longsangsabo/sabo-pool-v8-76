...
const UserStatsPage: React.FC = () => {
  ...
  const achievements = [
    { id: 1, name: 'First Victory', description: 'Win your first match', unlocked: true, date: '2024-01-15' },
    { id: 2, name: 'Streak Master', description: 'Win 10 matches in a row', unlocked: true, date: '2024-03-22' },
    { id: 3, name: 'Tournament Champion', description: 'Win a tournament', unlocked: true, date: '2024-04-10' },
    { id: 4, name: 'Century Club', description: 'Play 100 matches', unlocked: true, date: '2024-05-20' },
    { id: 5, name: 'Perfectionist', description: 'Win 50 matches in a row', unlocked: false, date: null },
    { id: 6, name: 'Legend', description: 'Reach Diamond rank', unlocked: false, date: null }
  ];
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Your overall pool performance statistics</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center">
                    <p className="text-2xl font-bold text-green-500">{overallStats.wins}</p>
                    <p className="text-sm text-gray-500">Wins</p>
                  </div>
                  <div className="text-center">
                    <p className="text-2xl font-bold text-red-500">{overallStats.losses}</p>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                  <div className="text-center">
                    <p className="text-lg font-semibold">{overallStats.bestStreak}</p>
                    <p className="text-sm text-gray-500">Best Streak</p>
                  </div>
                  <div className="text-center">
                    <p className="text-lg font-semibold">{overallStats.hoursPlayed}h</p>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Your current ranking and ELO rating</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-sm text-gray-500">ELO: {overallStats.elo}</p>
                </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your match performance over the last 6 months</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {monthlyStats.map((month, index) => (
                  <div key={index} className="flex items-center space-x-4">
                    ...
                    <div className="flex-1 space-y-1">
                      <div className="flex justify-between text-sm">
                        <span>{month.wins}/{month.matches} wins</span>
                        <span>{Math.round((month.wins / month.matches) * 100)}%</span>
                      </div>
                      <Progress value={(month.wins / month.matches) * 100} className="h-2" />
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-sm text-gray-500 mt-2">7 wins in last 10 matches (70%)</p>
              </CardContent>
            </Card>
        ...
        <TabsContent value="history" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your latest match results and details</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {[
                  { date: '2024-06-15', opponent: 'Player123', result: 'Win', score: '8-6', duration: '32m' },
                  { date: '2024-06-14', opponent: 'PoolMaster', result: 'Win', score: '8-4', duration: '28m' },
                  { date: '2024-06-13', opponent: 'BallHunter', result: 'Loss', score: '5-8', duration: '35m' },
                  { date: '2024-06-12', opponent: 'ShotCaller', result: 'Win', score: '8-7', duration: '41m' },
                  { date: '2024-06-11', opponent: 'CueStick99', result: 'Win', score: '8-3', duration: '25m' }
                ].map((match, index) => (
