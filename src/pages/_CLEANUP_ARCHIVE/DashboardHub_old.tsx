    ...
    <div className='compact-grid compact-grid-cols-4'>
      ...
      <Card className='compact-card'>
        ...
        <CardContent className='compact-card-content'>
          ...
          <p className='text-xs text-muted-foreground'>Tăng 5 bậc</p>
        </CardContent>
      </Card>
    </div>
    ...
    <Card>
      ...
      <CardContent className='space-y-4'>
        ...
        <div className='flex items-start space-x-3'>
          ...
          <div className='flex-1'>
            <p className='text-sm'>
              <strong>Trần Thị B</strong> đã gửi thách đấu cho{' '}
    ...
    return (
      <div className='min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-green-900'>
        <Helmet>
          ...
          <meta
            name='description'
            content='Hệ thống quản lý và đặt bàn bi-a SABO Pool Arena'
          />
        </Helmet>
  ...
  return (
    <div className='compact-container compact-layout desktop-high-density'>
      <Helmet>
        ...
        <meta
          name='description'
          content='Dashboard tổng hợp - SABO Pool Arena'
        />
      </Helmet>
      ...
      >
        <TabsList className='grid w-full grid-cols-4 h-9 md:h-10'>
          <TabsTrigger
            value='dashboard'
            className='compact-nav-item flex items-center gap-1'
          >
