...
const EnhancedMarketplacePage = React.lazy(() => import('@/pages/EnhancedMarketplacePage'));
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Tìm hiểu mọi thứ trong thế giới billiards</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="p-4">
          <div className="text-center">
            ...
            <div className="text-sm text-muted-foreground">Người chơi hoạt động</div>
          </div>
        </Card>
        <Card className="p-4">
          <div className="text-center">
        ...
        <Card className="p-4">
          <div className="text-center">
            ...
            <div className="text-sm text-muted-foreground">Bài viết tuần này</div>
          </div>
        </Card>
        <Card className="p-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-orange-500">1,234</div>
            <div className="text-sm text-muted-foreground">Lượt xem hôm nay</div>
          </div>
        </Card>
      </div>
        ...
        <Card className="p-4">
          ...
          <div className="space-y-3">
            <div className="p-3 border rounded-lg cursor-pointer hover:bg-muted/50">
              <div className="font-medium text-sm">Tournament Spring Championship 2024</div>
              <div className="text-xs text-muted-foreground">
            ...
            <div className="p-3 border rounded-lg cursor-pointer hover:bg-muted/50">
              <div className="font-medium text-sm">Cập nhật hệ thống ranking mới</div>
              <div className="text-xs text-muted-foreground">
            ...
            <div className="p-3 border rounded-lg cursor-pointer hover:bg-muted/50">
              <div className="font-medium text-sm">Khai trương club mới tại TP.HCM</div>
              <div className="text-xs text-muted-foreground">
  ...
  <Card className="p-6">
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {[
          { name: 'Cơ Pool Professional', price: '2,500,000', oldPrice: '3,000,000', discount: '17%' },
          { name: 'Bàn Pool Premium', price: '45,000,000', oldPrice: '50,000,000', discount: '10%' },
          { name: 'Phấn Pool Cao Cấp', price: '150,000', oldPrice: '200,000', discount: '25%' },
        ].map((item, index) => (
          <Card key={index} className="p-4 cursor-pointer hover:shadow-md transition-shadow">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-lg font-bold text-green-600">{item.price}đ</span>
                <span className="text-sm text-muted-foreground line-through">{item.oldPrice}đ</span>
              </div>
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          {['Cơ pool', 'Tournament', 'Thách đấu', 'Bàn billiards', 'Phấn pool'].map((term, index) => (
            <span key={index} className="px-3 py-1 bg-muted text-muted-foreground rounded-full text-xs cursor-pointer hover:bg-muted/80">
              {term}
            </span>
          ))}
        </div>
