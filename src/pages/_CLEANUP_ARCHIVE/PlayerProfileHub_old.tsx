      ...
      <div className="compact-grid compact-grid-cols-4">
        <Card className="compact-card">
          <div className="text-center">
            <div className="responsive-text-lg font-bold text-green-500">156</div>
            <div className="responsive-text-xs text-muted-foreground">Trận thắng</div>
          </div>
        </Card>
        <Card className="compact-card">
          <div className="text-center">
            <div className="responsive-text-lg font-bold text-red-500">43</div>
            <div className="responsive-text-xs text-muted-foreground">Trận thua</div>
          </div>
        </Card>
        <Card className="compact-card">
          <div className="text-center">
            <div className="responsive-text-lg font-bold text-blue-500">78%</div>
            <div className="responsive-text-xs text-muted-foreground">Tỷ lệ thắng</div>
          </div>
        </Card>
        <Card className="compact-card">
          <div className="text-center">
            <div className="responsive-text-lg font-bold text-purple-500">1,285</div>
            <div className="responsive-text-xs text-muted-foreground">ELO Rating</div>
          </div>
        </Card>
      </div>
        ...
        <div className="space-y-2">
          <Card className="compact-card">
            <div className="flex justify-between items-center">
              <div>
                <div className="responsive-text-sm font-medium">Thắng Challenge vs ProPlayer123</div>
                <div className="responsive-text-xs text-muted-foreground">2 giờ trước</div>
              </div>
              <div className="responsive-text-xs text-green-500 font-medium">+50K</div>
            </div>
          </Card>
          <Card className="compact-card">
            <div className="flex justify-between items-center">
              <div>
                <div className="font-medium">Tham gia Tournament Spring Cup</div>
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        <Card className="p-4 text-center">
          ...
          <div className="text-sm text-muted-foreground">Chiến thắng đầu tiên</div>
        </Card>
        <Card className="p-4 text-center">
          ...
          <div className="text-sm text-muted-foreground">10 thắng liên tiếp</div>
        </Card>
    ...
    <div className="compact-container compact-layout desktop-high-density">
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="grid w-full grid-cols-5 h-9 md:h-10">
          ...
          <TabsTrigger value="profile" className="compact-nav-item flex items-center space-x-1">
            <User className="h-3 w-3 md:h-4 md:w-4" />
            <span className="hidden sm:inline responsive-text-xs">Hồ sơ</span>
          </TabsTrigger>
          <TabsTrigger value="stats" className="compact-nav-item flex items-center space-x-1">
            <TrendingUp className="h-3 w-3 md:h-4 md:w-4" />
            <span className="hidden sm:inline responsive-text-xs">Thống kê</span>
          </TabsTrigger>
          <TabsTrigger value="achievements" className="compact-nav-item flex items-center space-x-1">
            <Award className="h-3 w-3 md:h-4 md:w-4" />
            <span className="hidden sm:inline responsive-text-xs">Thành tích</span>
          </TabsTrigger>
          <TabsTrigger value="settings" className="compact-nav-item flex items-center space-x-1">
        ...
        <TabsContent value="achievements" className="mt-3 md:mt-6 mobile-compact">
          <Achievements />
        </TabsContent>
