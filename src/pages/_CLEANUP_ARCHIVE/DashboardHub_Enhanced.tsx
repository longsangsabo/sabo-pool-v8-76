...
const DashboardHub = () => {
  ...
  const recentActivities = [
    {
      type: 'match',
      description: 'Thắng vs Minh Hoàng',
      time: '2 giờ trước',
      result: 'win',
    },
    {
      type: 'challenge',
      description: 'Nhận thách đấu từ Đức Anh',
      time: '5 giờ trước',
      result: 'pending',
    },
    {
      type: 'tournament',
      description: 'Đăng ký Tournament Mùa Xuân',
      time: '1 ngày trước',
      result: 'success',
    },
    {
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='opacity-90'>
                Hôm nay bạn có {stats.activeChallenges} thách đấu và{' '}
                {stats.unreadMessages} tin nhắn mới
              </p>
            </div>
        ...
        <CardContent>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            ...
            <div className='space-y-3'>
              ...
              {['Billiards Center', 'Golden Cue', 'Champion Club'].map(
                (club, index) => (
                  <div
                    key={index}
                    className='flex items-center justify-between p-2 bg-gray-50 rounded-lg'
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      <Helmet>
        ...
        <meta
          name='description'
          content='Dashboard tổng quan và thống kê người chơi'
        />
      </Helmet>
      ...
      <div className='container mx-auto px-4 py-6 max-w-6xl'>
        <div className='mb-6'>
          ...
          <p className='text-gray-600 mt-1'>
            Tổng quan hoạt động và thành tích của bạn
          </p>
        </div>
            ...
            <Card>
              <CardContent className='py-12 text-center'>
                ...
                <p className='text-gray-600 mb-4'>
                  Xem lịch sử chi tiết các hoạt động
                </p>
