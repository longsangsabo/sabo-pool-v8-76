...
import { Eye, EyeOff, Mail, Phone, AlertTriangle, CheckCircle, User, Shield } from 'lucide-react';
...
const AuthPage = () => {
  ...
  const { user, loading: authLoading, signInWithPhone, signInWithEmail, signUpWithPhone, signUpWithEmail } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        const successMessage = mode === 'login' ? 'Đăng nhập thành công!' : 'Đăng ký thành công!';
  ...
  const getPageIcon = () => {
    switch (mode) {
      case 'register': return <User className="h-6 w-6" />;
      case 'forgot-password': return <Mail className="h-6 w-6" />;
      case 'reset-password': return <Shield className="h-6 w-6" />;
      default: return '🎱';
    }
  };
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="phone" className="space-y-4">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {mode === 'register' && (
                      <div className="space-y-2">
                        <Label htmlFor="confirmPhonePassword">Xác nhận mật khẩu</Label>
                        <Input
                    ...
                    >
                      {loading ? (
                        ...
                        mode === 'register' ? 'Đăng ký với SĐT' : 'Đăng nhập với SĐT'
                      )}
                    </Button>
                  </form>
                </TabsContent>
                ...
                <TabsContent value="email" className="space-y-4">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {mode === 'register' && (
                      <div className="space-y-2">
                        <Label htmlFor="confirmEmailPassword">Xác nhận mật khẩu</Label>
                        <Input
                    ...
                    >
                      {loading ? (
                        ...
                        mode === 'register' ? 'Đăng ký với Email' : 'Đăng nhập với Email'
                      )}
                    </Button>
                  </form>
                </TabsContent>
