          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between mt-3">
              <span className={`text-xs px-2 py-1 rounded-full ${
                player.status === 'online' ? 'bg-green-100 text-green-700 dark:bg-green-900/20' :
                player.status === 'playing' ? 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/20' :
    ...
    <div className="container mx-auto p-4 max-w-6xl">
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Kết nối với các billiard thủ khác, tìm kiếm đối thủ và mở rộng mạng lưới bạn bè
        </p>
      </div>
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground mb-4">
                Hãy bắt đầu kết nối với các billiard thủ khác để xây dựng mạng lưới bạn bè
              </p>
              <Button>
