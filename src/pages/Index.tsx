      ...
      <div className="min-h-screen relative">
        ...
        <section className="relative z-10 container mx-auto px-4 tablet:px-8 py-20 tablet:py-24 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 tablet:gap-6 justify-center">
            <Link to="/register">
              <Button size="lg" className="bg-yellow-400 text-slate-900 hover:bg-yellow-500 px-8 py-3 tablet:px-12 tablet:py-4 text-lg tablet:text-xl">
          ...
          <div className="grid md:grid-cols-2 tablet:grid-cols-3 gap-8 tablet:gap-8">
            <Card className="bg-slate-800/80 backdrop-blur-sm border-slate-700/50 tablet:p-8">
              <CardHeader className="tablet:pb-6">
                ...
                <CardTitle className="text-white tablet:text-2xl">Hệ thống ELO chuyên nghiệp</CardTitle>
            ...
            <Card className="bg-slate-800/80 backdrop-blur-sm border-slate-700/50 tablet:p-8">
              <CardHeader className="tablet:pb-6">
                ...
                <CardTitle className="text-white tablet:text-2xl">Cộng đồng sôi động</CardTitle>
                <CardDescription className="text-gray-300 tablet:text-lg">
            ...
            <Card className="bg-slate-800/80 backdrop-blur-sm border-slate-700/50 tablet:p-8">
              <CardHeader className="tablet:pb-6">
                ...
                <CardTitle className="text-white tablet:text-2xl">Giải đấu thường xuyên</CardTitle>
                <CardDescription className="text-gray-300 tablet:text-lg">
        ...
        <section className="relative z-10 container mx-auto px-4 tablet:px-8 py-20 tablet:py-24">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 tablet:gap-8 text-center">
            <div>
              <div className="text-4xl tablet:text-5xl font-bold text-yellow-400 mb-2 tablet:mb-4">5,000+</div>
              <div className="text-gray-300 tablet:text-lg">Người chơi</div>
            </div>
            <div>
              <div className="text-4xl tablet:text-5xl font-bold text-yellow-400 mb-2 tablet:mb-4">200+</div>
              <div className="text-gray-300 tablet:text-lg">Arena đối tác</div>
            </div>
            <div>
              <div className="text-4xl tablet:text-5xl font-bold text-yellow-400 mb-2 tablet:mb-4">1,000+</div>
              <div className="text-gray-300 tablet:text-lg">Giải đấu</div>
            </div>
            <div>
              <div className="text-4xl tablet:text-5xl font-bold text-yellow-400 mb-2 tablet:mb-4">50K+</div>
