        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <h2 className="text-xl font-semibold mb-2">Chưa có thông tin club</h2>
              <p className="text-muted-foreground">
                Bạn chưa đăng ký làm chủ club. Vui lòng liên hệ quản trị viên để được hỗ trợ.
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <Card>
            ...
            <CardContent>
                ...
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-muted-foreground">Yêu cầu chờ xử lý</p>
                    </div>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-2xl font-bold">0</p>
                      <p className="text-sm text-muted-foreground">Lịch test tuần này</p>
                    </div>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-2xl font-bold">0</p>
                      <p className="text-sm text-muted-foreground">Hạng đã duyệt tháng này</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="mt-8 text-center text-muted-foreground">
                <p>Thống kê chi tiết sẽ được cập nhật trong phiên bản tiếp theo</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="settings" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Tùy chỉnh quy trình test hạng, tiêu chí đánh giá và thông báo
                  </p>
                </div>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Thêm và quản lý danh sách giảng viên có thể thực hiện test hạng
                  </p>
                </div>
              ...
              <div className="mt-8 text-center text-muted-foreground">
                <p>Các tính năng cài đặt sẽ được phát triển trong phiên bản tiếp theo</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
