...
const SeasonHistoryPage: React.FC = () => {
  const seasons = [
    ...
    },
    {
      ...
      champion: 'BallHunter',
      myRank: 12,
      myStats: { matches: 25, wins: 16, winRate: 64.0 },
    },
    {
      id: 'season-2023-1',
      name: 'Season 2023.1',
      ...
      champion: 'ShotCaller',
      myRank: 20,
      myStats: { matches: 20, wins: 12, winRate: 60.0 },
    },
  ];
  ...
  const achievements = [
    ...
    {
      season: 'Season 2023.2',
      achievement: 'Most Improved Player',
      icon: TrendingUp,
    },
    {
      season: 'Season 2023.1',
      achievement: 'Newcomer of the Season',
      icon: Star,
    },
  ];
        ...
        <TabsContent value='seasons' className='space-y-6'>
          <div className='space-y-4'>
            {seasons.map(season => (
              <Card
                key={season.id}
                className={`${season.status === 'current' ? 'ring-2 ring-blue-500' : ''}`}
              >
                <CardHeader>
                  <div className='flex items-center justify-between'>
                    <div>
                ...
                <CardContent className='space-y-4'>
                  <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                    ...
                    <div className='text-center'>
                      <div className='text-lg font-semibold'>
                        {season.myStats.wins}/{season.myStats.matches}
                      </div>
                      <div className='text-sm text-gray-500'>Your W/L</div>
                    </div>
                    <div className='text-center'>
                      <div className='text-lg font-semibold'>
                        {season.myStats.winRate}%
                      </div>
                      ...
                      >
                        ...
                        <div className='flex-1 space-y-1'>
                          <div className='flex justify-between text-sm'>
                            ...
                            <span>
                              {Math.round(
                                ((season.participants - season.myRank) /
                                  season.participants) *
                                  100
                              )}
                              th percentile
                          ...
                          <div className='w-full bg-gray-200 rounded-full h-2'>
                            <div
                              ...
                              style={{
                                width: `${((season.participants - season.myRank) / season.participants) * 100}%`,
                              }}
                            />
                          </div>
                        </div>
                    ...
                    {seasons.map((season, index) => (
                      ...
                      >
                        ...
                        <div className='flex-1 space-y-1'>
                          <div className='flex justify-between text-sm'>
                            <span>
                              {season.myStats.wins}W-
                              {season.myStats.matches - season.myStats.wins}L
                            </span>
