    ...
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        <div>
          <h2 className='text-2xl font-bold'>
            Official ELO System Integration
          </h2>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-4 text-center'>
              <div>
                <p className='text-2xl font-bold text-green-600'>
                  {
                    integrationStatus.filter(s => s.status === 'integrated')
                      .length
                  }
                </p>
            ...
            <div>
              ...
              <ul className='space-y-2'>
                <li className='flex items-start gap-2 text-sm'>
                  ...
                  <span>
                    <strong>12 tiers:</strong> K → K+ → I → I+ → H → H+ → G → G+
                    → F → F+ → E → E+
                  </span>
                </li>
                <li className='flex items-start gap-2 text-sm'>
                  <div className='w-1.5 h-1.5 bg-green-500 rounded-full mt-2' />
                  <span>
                    <strong>Consistent gaps:</strong> 100 ELO points between
                    adjacent ranks
                  </span>
                </li>
                <li className='flex items-start gap-2 text-sm'>
                  <div className='w-1.5 h-1.5 bg-green-500 rounded-full mt-2' />
                  <span>
                    <strong>Base range:</strong> 1000-2100+ ELO (E+ is
                    open-ended)
                  </span>
                </li>
                <li className='flex items-start gap-2 text-sm'>
                  <div className='w-1.5 h-1.5 bg-green-500 rounded-full mt-2' />
                  <span>
                    <strong>Clear milestone:</strong> Rank G (1600+) = reliable
                    1-ball clearance
                  </span>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className='space-y-2'>
                <li className='flex items-start gap-2 text-sm'>
                  ...
                  <span>
                    <strong>Champion:</strong> +80 ELO (highest reward)
                  </span>
                </li>
                <li className='flex items-start gap-2 text-sm'>
                  <div className='w-1.5 h-1.5 bg-blue-500 rounded-full mt-2' />
                  <span>
                    <strong>Runner-up:</strong> +40 ELO (50% of champion)
                  </span>
                </li>
                <li className='flex items-start gap-2 text-sm'>
                  <div className='w-1.5 h-1.5 bg-blue-500 rounded-full mt-2' />
                  <span>
                    <strong>Scalable rewards:</strong> Position-based từ +5 đến
                    +80
                  </span>
                </li>
                <li className='flex items-start gap-2 text-sm'>
                  <div className='w-1.5 h-1.5 bg-blue-500 rounded-full mt-2' />
                  <span>
                    <strong>Skill correlation:</strong> Perfect alignment với
                    ball-potting abilities
                  </span>
                </li>
              </ul>
            </div>
      ...
      <div className='text-center space-y-2'>
        ...
        <p className='text-sm text-muted-foreground'>
          Hệ thống ELO từ <code>RANK_SYSTEM_README.md</code> đã được tích hợp
          hoàn toàn vào Game Configuration, backend database, và frontend
          components.
        </p>
