...
const TournamentPrizeManager: React.FC<TournamentPrizeManagerProps> = ({
    ...
    additionalRewards: [
      {
        id: '1',
        title: 'Best Break',
        description: 'Highest break shot',
      ...
      },
      {
        ...
        description: 'Best sportsmanship',
        criteria: 'Behavior',
        value: 1000000,
      },
    ],
  ...
  const updateSponsorContribution = (
    id: string,
    updates: Partial<SponsorContribution>
  ) => {
    setPrizeStructure(prev => ({
      ...prev,
  ...
  const removeSponsorContribution = (id: string) => {
    setPrizeStructure(prev => ({
      ...prev,
      sponsorContributions: prev.sponsorContributions.filter(
  ...
  const calculateTotalDistribution = () => {
    return prizeStructure.distribution.reduce(
  ...
  const calculateSponsorTotal = () => {
    return prizeStructure.sponsorContributions.reduce(
  ...
  const remainingPrizePool =
    prizeStructure.totalPrizePool - calculateTotalDistribution();
                  ...
                  <div className='flex-1 grid grid-cols-1 md:grid-cols-4 gap-4'>
                    <div>
                      ...
                      <Input
                        value={prize.title}
                        onChange={e =>
                          updatePrizeItem(prize.id, { title: e.target.value })
                        }
                        className='mt-1'
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={e =>
                          updatePrizeItem(prize.id, {
                            type: e.target.value as 'cash' | 'trophy' | 'gift',
                          })
                        }
                ...
                <div className='flex-1 grid grid-cols-1 md:grid-cols-4 gap-4'>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        updateSponsorContribution(sponsor.id, {
        ...
        <CardContent>
          <div className='space-y-3'>
            ...
            <div className='flex justify-between'>
              ...
              <span>
                {formatCurrency(
                  prizeStructure.additionalRewards.reduce(
            ...
            <div className='flex justify-between text-lg font-bold'>
              ...
              <span
                className={
                  remainingPrizePool >= 0 ? 'text-green-600' : 'text-red-600'
                }
              >
                {formatCurrency(remainingPrizePool)}
              </span>
