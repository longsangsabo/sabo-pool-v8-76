...
const AdminAutomationNew = () => {
      ...
      actions: [
        {
          ...
          config: {
            query:
              'SELECT * FROM tournaments WHERE start_date = DATE_ADD(NOW(), INTERVAL 1 DAY)',
          },
        },
      ...
      actions: [
        {
          ...
          config: {
            query:
              'UPDATE users SET status = "inactive" WHERE last_active < NOW() - INTERVAL 90 DAY',
          },
        },
        {
          id: '2',
          type: 'notification',
          config: { message: 'Inactive user cleanup completed' },
        },
      ],
      status: 'active',
    ...
    },
    {
      ...
      actions: [
        ...
        },
        {
          id: '2',
          type: 'notification',
          config: { channel: 'slack', webhook: 'https://hooks.slack.com/...' },
        },
      ],
      status: 'paused',
  ...
  const stats = [
    ...
    },
    {
      ...
      value: automationRules
        .reduce((sum, rule) => sum + rule.runCount, 0)
        .toLocaleString(),
