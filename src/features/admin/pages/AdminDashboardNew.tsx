  ...
  const [metrics, setMetrics] = useState<DashboardMetric[]>([
    {
      ...
      color: 'text-blue-600',
      trend: [
        100, 120, 140, 135, 155, 145, 165, 180, 190, 185, 200, 195, 210, 225,
      ],
    },
    {
      id: '2',
    ...
    },
    {
      ...
      trend: [
        1000, 1200, 1100, 1400, 1300, 1500, 1600, 1550, 1700, 1650, 1800, 1750,
        1900, 2000,
      ],
    },
    {
      ...
      trend: [
        99.95, 99.96, 99.97, 99.98, 99.99, 99.98, 99.97, 99.98, 99.99, 99.98,
    ...
    },
    {
      ...
      trend: [
        800, 850, 820, 880, 860, 900, 920, 910, 950, 940, 980, 970, 1000, 950,
      ],
    },
    {
      id: '6',
      ...
      trend: [
        2.1, 2.3, 2.2, 2.5, 2.4, 2.7, 2.8, 2.9, 3.0, 2.9, 3.2, 3.1, 3.4, 3.5,
      ],
    },
  ]);
  ...
  const [systemAlerts, setSystemAlerts] = useState<SystemAlert[]>([
    {
      ...
      message:
        'Server memory usage has reached 85%. Consider scaling resources.',
            ...
            <div className='flex items-center justify-between'>
              <div className='flex items-center gap-4'>
                <Select value={timeRange} onValueChange={setTimeRange}>
                  ...
                  <SelectContent>
                    <SelectItem value='1d'>
                      {t('dashboard.time_range.1d')}
                    </SelectItem>
                    <SelectItem value='7d'>
                      {t('dashboard.time_range.7d')}
                    </SelectItem>
                    <SelectItem value='30d'>
                      {t('dashboard.time_range.30d')}
                    </SelectItem>
                    <SelectItem value='90d'>
                      {t('dashboard.time_range.90d')}
                    </SelectItem>
                  </SelectContent>
                </Select>
          ...
          <CardContent>
            <div className='space-y-4'>
              {recentActivities.map(activity => (
                ...
                >
                  <div
                    className={`p-2 rounded-lg ${getActivityColor(activity.status)}`}
                  >
