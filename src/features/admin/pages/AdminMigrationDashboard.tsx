...
const AdminMigrationDashboard = () => {
  ...
  const migrationComponents = [
    {
      name: 'AdminClubsNew',
      status: 'completed',
      description: 'Modern club management system',
      progress: 100,
    },
    {
      name: 'AdminUsersNew',
    ...
    },
    {
      ...
      status: 'completed',
      description: 'Advanced transaction handling',
      progress: 100,
    },
    {
      name: 'AdminTournamentsNew',
      status: 'completed',
      description: 'Complete tournament system',
      progress: 100,
    },
    {
      name: 'AdminAnalyticsNew',
      status: 'completed',
      description: 'Advanced analytics dashboard',
      progress: 100,
    },
    {
      name: 'AdminSettingsNew',
      status: 'completed',
      description: 'Comprehensive settings management',
      progress: 100,
    },
    {
      name: 'AdminDatabaseNew',
      status: 'completed',
      description: 'Database administration tools',
      progress: 100,
    },
    {
      name: 'AdminAutomationNew',
      status: 'completed',
  ...
  const completedItems = migrationItems.filter(
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                  ...
                  <div className='text-center'>
                    <div className='text-2xl font-bold text-yellow-600'>
                      {
                        migrationItems.filter(item => item.status === 'pending')
                          .length
                      }
                    </div>
                ...
                <CardContent>
                  <div className='space-y-3'>
                    <div className='flex items-center justify-between text-sm'>
                      <span>
                        Old: <code>{item.oldPath}</code>
                      </span>
                      <ArrowRight className='h-4 w-4 text-muted-foreground' />
                      <span>
                        New: <code>{item.newPath}</code>
                      </span>
                    </div>
                    <div className='text-sm text-muted-foreground'>
                  ...
                  <div>
                    ...
                    <div className='space-y-2 text-sm'>
                      ...
                      <div>
                        ...
                        <code>{selectedItem.oldPath}</code>
                      </div>
                      <div>
                        <strong>New Path:</strong>{' '}
                        <code>{selectedItem.newPath}</code>
                      </div>
                    </div>
                  </div>
                </div>
