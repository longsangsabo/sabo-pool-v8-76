...
const AdminNotificationsNew = () => {
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      content:
        'Registration for the Summer Championship is now open! Join now and compete for the grand prize.',
      type: 'announcement',
      priority: 'high',
      status: 'sent',
    ...
    },
    {
      ...
      content:
        'Scheduled maintenance will occur tonight from 2:00 AM to 4:00 AM. Please save your progress.',
      type: 'warning',
      priority: 'medium',
      status: 'scheduled',
    ...
    },
    {
      ...
      content:
        'Your tournament entry fee has been successfully processed. Good luck in the competition!',
      type: 'success',
      priority: 'low',
      status: 'sent',
  ...
  const [templates, setTemplates] = useState<NotificationTemplate[]>([
    {
      ...
      content:
        'Registration for {tournament_name} is now open! Entry fee: {entry_fee}. Deadline: {deadline}.',
      type: 'announcement',
      category: 'tournament',
  ...
  const handleCancelNotification = (notificationId: string) => {
    setNotifications(prev =>
      prev.map(notif =>
        notif.id === notificationId ? { ...notif, status: 'cancelled' } : notif
      )
    );
                  ...
                  {selectedNotification ? (
                    <Card>
                      ...
                      <CardContent className='space-y-6'>
                        ...
                        <div className='text-sm text-muted-foreground'>
                          <div>
                            Created:{' '}
                            {selectedNotification.createdAt.toLocaleString()} by{' '}
                            {selectedNotification.createdBy}
                          </div>
                          {selectedNotification.scheduledAt && (
                            <div>
                              Scheduled:{' '}
                              {selectedNotification.scheduledAt.toLocaleString()}
                            </div>
                          )}
                    ...
                    <Card>
                      <CardContent className='p-12 text-center'>
                        ...
                        <p className='text-muted-foreground'>
                          Choose a notification to view details and manage
                          delivery.
                        </p>
                      </CardContent>
                    </Card>
            ...
            <TabsContent value='campaigns'>
              <Card>
                <CardContent className='p-12 text-center'>
                  ...
                  <p className='text-muted-foreground'>
                    Advanced campaign tracking and management features coming
                    soon.
                  </p>
                </CardContent>
              </Card>
            ...
            <TabsContent value='analytics'>
              <Card>
                <CardContent className='p-12 text-center'>
                  ...
                  <p className='text-muted-foreground'>
                    Detailed analytics and reporting for notification
                    performance.
                  </p>
                </CardContent>
              </Card>
            ...
            <TabsContent value='settings'>
              <Card>
                <CardContent className='p-12 text-center'>
                  ...
                  <p className='text-muted-foreground'>
                    Configure notification channels, delivery settings, and
                    preferences.
                  </p>
                </CardContent>
              </Card>
