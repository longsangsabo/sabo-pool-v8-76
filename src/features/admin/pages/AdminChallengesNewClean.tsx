...
function AdminChallengesNewContent() {
  ...
  const [selectedChallenge, setSelectedChallenge] =
    useState<ChallengeWithProfiles | null>(null);
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        console.log(
          'AdminChallengesNew: Challenges fetched, count:',
  ...
  useEffect(() => {
    console.log(
      'AdminChallengesNew: Challenges updated:',
            ...
            {loading ? (
              ...
              <div className='p-8 text-center'>
                ...
                <div className='text-muted-foreground'>
                  Chưa có thách đấu nào được tạo hoặc chưa load được data từ
                  database
                </div>
              </div>
            ) : (
                          ...
                          <td className='p-4'>
                            <div className='flex items-center gap-2'>
                              ...
                              <div>
                                ...
                                <div className='text-sm text-muted-foreground'>
                                  {challenge.challenger?.verified_rank ||
                                    'No rank'}
                                </div>
                              </div>
                            </div>
                          ...
                          <td className='p-4'>
                            <div className='flex items-center gap-2'>
                              ...
                              <div>
                                ...
                                <div className='text-sm text-muted-foreground'>
                                  {challenge.opponent?.verified_rank ||
                                    'No rank'}
                                </div>
                              </div>
                            </div>
        ...
        <DialogContent className='max-w-md'>
          ...
          <div className='space-y-4'>
            ...
            <div className='flex justify-end gap-2'>
              ...
              <Button onClick={handleCreateChallenge}>Tạo thách đấu</Button>
            </div>
          </div>
        </DialogContent>
      </Dialog>
