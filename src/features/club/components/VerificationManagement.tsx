...
export const VerificationManagement = ({ clubId }: { clubId: string }) => {
  ...
  const selectedVerificationData = verifications.find(
    ...
    <>
      ...
      >
        <DialogContent className='max-w-md'>
          <DialogHeader>
            <DialogTitle>
              Xác thực yêu cầu của{' '}
              {selectedVerificationData?.profiles.full_name}
            </DialogTitle>
          </DialogHeader>
              ...
              <div className='p-4 bg-gray-50 rounded-lg'>
                <div className='text-sm space-y-2'>
                  <div>
                    ...
                    {selectedVerificationData.current_rank}
                  </div>
                  <div>
                    <strong>Cấp độ yêu cầu:</strong>{' '}
                    {selectedVerificationData.requested_rank}
                  </div>
                  <div>
                    <strong>Lý do:</strong>{' '}
                    {selectedVerificationData.evidence_description}
                  </div>
                </div>
              </div>
          ...
          <DialogFooter className='gap-2'>
            ...
            <Button
              ...
              onClick={() =>
                selectedVerification && handleReject(selectedVerification)
              }
              disabled={loading}
            >
            ...
            <Button
              onClick={() =>
                selectedVerification && handleApprove(selectedVerification)
              }
              disabled={loading}
