  ...
  const handleCreateTournament = async (data: any) => {
    try {
      ...
      const newTournament: Tournament = {
        ...
        status: 'upcoming',
        type:
          data.tournament_type === 'single_elimination' ? 'single' : 'double',
        participants: 0,
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Tạo và quản lý các giải đấu CLB
          </p>
        </div>
                    ...
                    <div className='flex-1'>
                      ...
                      <div className='grid grid-cols-2 md:grid-cols-4 gap-4 text-sm'>
                        ...
                        <div className='flex items-center gap-2'>
                          ...
                          <span>
                            Phí: {tournament.entryFee.toLocaleString()}đ
                          </span>
                        </div>
                        <div className='flex items-center gap-2'>
                          <Star className='h-4 w-4' />
                          <span>
                            Giải: {tournament.prizePool.toLocaleString()}đ
                          </span>
                        </div>
                      </div>
                    </div>
        ...
        <TabsContent value='participants' className='space-y-6'>
          <Card>
            <CardContent className='p-8 text-center'>
              ...
              <Button variant='outline'>Xem danh sách thành viên</Button>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value='brackets' className='space-y-6'>
          <Card>
            <CardContent className='p-8 text-center'>
              ...
              <Button variant='outline'>Tạo bảng đấu</Button>
            </CardContent>
          </Card>
        </TabsContent>
