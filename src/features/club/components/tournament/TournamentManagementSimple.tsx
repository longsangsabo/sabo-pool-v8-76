...
export const TournamentManagementSimple: React.FC<TournamentManagementProps> = ({ clubId }) => {
  const { tournaments, loading, error, createTournament, updateTournament, deleteTournament, getTournamentStats } = useClubTournaments(clubId);
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setNewTournamentData({...newTournamentData, start_date: e.target.value})}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setNewTournamentData({...newTournamentData, end_date: e.target.value})}
                    />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setNewTournamentData({...newTournamentData, max_participants: parseInt(e.target.value)})}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setNewTournamentData({...newTournamentData, entry_fee: parseInt(e.target.value)})}
                    />
                  </div>
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewTournamentData({...newTournamentData, prize_pool: parseInt(e.target.value)})}
                  />
                </div>
                <div>
                  <Label htmlFor="tournament_type">Loại giải</Label>
                  <Select value={newTournamentData.tournament_type} onValueChange={(value: any) => setNewTournamentData({...newTournamentData, tournament_type: value})}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg">
            ...
            <div>
              <h4 className="font-semibold text-green-800">{stats.activeTournaments}</h4>
          ...
          <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-lg">
            ...
            <div>
              <h4 className="font-semibold text-blue-800">{stats.upcomingTournaments}</h4>
          ...
          <div className="flex items-center gap-3 p-4 bg-purple-50 rounded-lg">
            ...
            <div>
              <h4 className="font-semibold text-purple-800">{stats.totalParticipants}</h4>
          ...
          <div className="flex items-center gap-3 p-4 bg-yellow-50 rounded-lg">
            ...
            <div>
              <h4 className="font-semibold text-yellow-800">{stats.totalPrizePool.toLocaleString()}đ</h4>
                    ...
                    <div className="space-y-3 flex-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span>{new Date(tournament.start_date).toLocaleDateString('vi-VN')}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Star className="w-4 h-4" />
                          <span>{tournament.entry_fee?.toLocaleString() || 0}đ</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Trophy className="w-4 h-4" />
                          <span>{tournament.prize_pool?.toLocaleString() || 0}đ</span>
                        </div>
                      </div>
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          {tournaments.map((tournament) => (
            <Card key={tournament.id} className="border-l-4 border-l-yellow-400">
              <CardContent className="p-6">
        ...
        {tournaments.length === 0 && (
          <div className="text-center py-12 text-muted-foreground">
            ...
            <p className="text-sm mb-4">Tạo giải đấu đầu tiên cho CLB của bạn</p>
            <Button>
