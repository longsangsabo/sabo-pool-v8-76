                  ...
                  <CardContent className='p-6'>
                    <div className='flex items-center justify-between'>
                      <div className='flex-1'>
                        ...
                        <h3 className='text-2xl font-bold mt-1'>
                          {stats.tablesInUse}/{stats.totalTables}
                        </h3>
                        <p className='text-xs text-muted-foreground mt-1'>
                          Tỷ lệ{' '}
                          {Math.round(
                            (stats.tablesInUse / stats.totalTables) * 100
                          )}
                          %
                        </p>
                      </div>
                    ...
                    <div className='space-y-3'>
                      ...
                      <div className='bg-blue-50 p-3 rounded-lg'>
                        ...
                        <p className='text-sm text-blue-800'>
                          Cần thể hiện thêm kỹ thuật side spin.
                        </p>
                      </div>
                      ...
                      <div className='space-y-2'>
                        <div className='flex items-center justify-between p-3 bg-gray-50 rounded-lg'>
                          <span className='text-sm'>
                            Tự động duyệt người mới
                          </span>
                          <Badge variant='default'>Đã bật</Badge>
                        </div>
                        <div className='flex items-center justify-between p-3 bg-gray-50 rounded-lg'>
                          <span className='text-sm'>
                            Yêu cầu video minh chứng
                          </span>
                          <Badge variant='default'>Đã bật</Badge>
                        </div>
                        <div className='flex items-center justify-between p-3 bg-gray-50 rounded-lg'>
                          <span className='text-sm'>
                            Elo tối thiểu thách đấu
                          </span>
