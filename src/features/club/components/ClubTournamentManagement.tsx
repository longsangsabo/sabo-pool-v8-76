        ...
        <Tabs defaultValue="upcoming">
          ...
          <TabsContent value="active" className="p-0">
            <div className="p-4 bg-muted/30 rounded-md">
              <p className="text-center text-muted-foreground">No active tournaments at the moment</p>
            </div>
          </TabsContent>
          
          <TabsContent value="participants" className="p-0">
            <div className="p-4 bg-muted/30 rounded-md">
              <p className="text-center text-muted-foreground">Select a tournament to view participants</p>
            </div>
          </TabsContent>
          
          <TabsContent value="settings" className="p-0">
            <div className="p-4 bg-muted/30 rounded-md">
              <p className="text-center text-muted-foreground">Tournament settings coming soon</p>
            </div>
          </TabsContent>
        </Tabs>
      </CardContent>
