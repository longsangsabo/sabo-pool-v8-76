...
export const EnhancedTableManagement = () => {
  ...
  const getGameTypeBadge = (type: string) => {
    ...
    const { variant, text } =
      variants[type as keyof typeof variants] || variants.practice;
        ...
        <div className='space-y-3'>
            ...
            <div className='bg-red-50 p-3 rounded-lg'>
              ...
              <div className='space-y-1 text-sm'>
                <div className='flex justify-between'>
                  <span>
                    {table.current_session.player1} vs{' '}
                    {table.current_session.player2}
                  </span>
                ...
                <div className='flex items-center gap-1 text-muted-foreground'>
                  ...
                  {new Date(
                    table.current_session.start_time
            ...
            <div className='bg-blue-50 p-3 rounded-lg'>
              ...
              <div className='text-sm'>
                ...
                <div className='text-muted-foreground'>
                  {new Date(table.next_reservation.time).toLocaleTimeString(
                    'vi-VN',
                    {
                      hour: '2-digit',
                      minute: '2-digit',
          ...
          <div className='grid grid-cols-2 gap-2 text-sm'>
            <div className='flex items-center gap-1'>
              ...
              <span>
                Hôm nay: {table.total_revenue_today.toLocaleString()}đ
              </span>
            </div>
            <div className='flex items-center gap-1'>
  ...
  const totalRevenue = tables.reduce(
    (sum, table) => sum + table.total_revenue_today,
    0
  );
  const totalUsageHours = tables.reduce(
    (sum, table) => sum + table.usage_hours_today,
    0
  );
      ...
      <div className='flex justify-between items-center'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Theo dõi và quản lý việc sử dụng bàn billiards
          </p>
        </div>
              ...
              >
                ...
                <div className='text-right'>
                  <div className='font-medium'>
                    {reservation.total_cost.toLocaleString()}đ
                  </div>
                  <Badge
                    variant={
