...
export const RANK_DEFINITIONS: Record<string, RankInfo> = {
  ...
  'H': { 
    ...
    requirements: ['Đi 5-8 bi', 'Có thể "rùa" 1 chấm hình dễ', 'Hiểu cơ bản về position']
  },
  'H+': { 
    name: 'Hạng H+', 
  ...
  'G': { 
    ...
    requirements: ['Clear 1 chấm + 3-7 bi kế', 'Bắt đầu điều bi 3 băng', 'Trình phong trào "ngon"']
  },
  'G+': { 
    name: 'Hạng G+', 
    description: 'Clear 1 chấm + 3-7 bi kế; trình phong trào "ngon"',
    requirements: ['Clear 1 chấm + 3-7 bi kế', 'Trình phong trào "ngon"', 'Điều bi 3 băng khá']
  },
  'F': { 
    name: 'Hạng F', 
    description: '60-80% clear 1 chấm, đôi khi phá 2 chấm',
    requirements: ['60-80% clear 1 chấm', 'Đôi khi phá 2 chấm', 'Safety & spin control khá chắc']
  },
  'F+': { 
    name: 'Hạng F+', 
    description: '60-80% clear 1 chấm; cao nhất nhóm trung cấp',
    requirements: ['60-80% clear 1 chấm', 'Cao nhất nhóm trung cấp', 'Safety & spin control chắc']
  },
  'E': { 
    name: 'Hạng E', 
    description: '90-100% clear 1 chấm, 70% phá 2 chấm',
    requirements: ['90-100% clear 1 chấm', '70% phá 2 chấm', 'Điều bi phức tạp, safety chủ động']
  },
  'E+': { 
    name: 'Hạng E+', 
    description: '90-100% clear 1 chấm; sát ngưỡng lên D (chưa mở)',
    requirements: ['90-100% clear 1 chấm', '70% phá 2 chấm', 'Sát ngưỡng lên D (chưa mở)']
  }
};
