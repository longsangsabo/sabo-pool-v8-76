...
if (typeof window !== 'undefined') {
  ...
  console.log('🔧 Debug utility loaded. Call debugTournamentRefresh() to force refresh.');
}
...
if (typeof window !== 'undefined') {
  ...
  console.log('🔧 Debug utility: Call logTournamentState() to see current tournament state.');
}