...
export const tournamentRegistrationSchema = z.object({
  ...
  current_rank: z
    .string()
    .min(1, 'Vui lòng chọn hạng hiện tại'),
...
export const EXPERIENCE_LEVELS = [
  { value: 'beginner', label: 'Mới bắt đầu (1-5 giải)', description: 'Ít kinh nghiệm thi đấu chính thức' },
  { value: 'intermediate', label: 'Trung bình (6-20 giải)', description: 'Có kinh nghiệm thi đấu cơ bản' },
  { value: 'experienced', label: 'Giàu kinh nghiệm (>20 giải)', description: 'Thường xuyên tham gia giải đấu' },
];

// Default form values
export const getDefaultRegistrationData = (): Partial<TournamentRegistrationFormData> => ({
  tournament_id: '',
  player_name: '',
  phone: '',
  email: '',
