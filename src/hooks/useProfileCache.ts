...
export const useProfileCache = () => {
  const [cachedProfiles, setCachedProfiles] = useState<ProfileCache>(profileCache);
  ...
  const getMultipleProfiles = useCallback(async (userIds: string[]): Promise<ProfileData[]> => {
