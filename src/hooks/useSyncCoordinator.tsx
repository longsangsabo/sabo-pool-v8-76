...
interface SyncCoordinator {
  syncData: (type: SyncDataType, data: any[], operation: SyncOperation) => Promise<void>;
  isSyncing: boolean;
...
export const useSyncCoordinator = (): SyncCoordinator => {
  ...
  const syncData = useCallback(async (type: SyncDataType, data: any[], operation: SyncOperation) => {
    setIsSyncing(true);
