-- Xóa các matches cũ và tạo lại bracket với cấu trúc mới cho giải "Bảng đấu SABO OPEN TOURNAMENT – Pool 9 Ball (hạng H - I - K)"
DO $$
DECLARE
...
BEGIN
    ...
    -- Lấy danh sách participants (giả sử có 16 người)
    ...
    RAISE NOTICE 'Successfully created Double Elimination bracket with 4-phase structure for tournament: %', tournament_uuid;
