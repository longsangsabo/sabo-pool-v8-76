-- Fix grant_spa_points function with comprehensive corrections
...
BEGIN
  ...
  -- Update or insert user's SPA points with all required fields
  ...
  ON CONFLICT (user_id) DO UPDATE SET
    spa_points = COALESCE(public.player_rankings.spa_points, 0) + p_amount,
    updated_at = NOW();
