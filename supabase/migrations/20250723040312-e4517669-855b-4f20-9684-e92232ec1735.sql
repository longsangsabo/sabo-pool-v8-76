...
-- Add some default milestone data (only if they don't exist)
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM public.spa_reward_milestones WHERE milestone_name = 'First Steps') THEN
