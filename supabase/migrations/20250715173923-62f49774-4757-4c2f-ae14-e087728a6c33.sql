-- Fix tournament progression logic to prevent duplicate finals
-- The issue is in advance_tournament_winner function where it continues to create matches
-- even after the tournament should be completed
