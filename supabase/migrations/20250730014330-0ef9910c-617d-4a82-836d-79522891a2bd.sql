-- SABO DOUBLE ELIMINATION DATABASE FUNCTIONS - FIXED
...
BEGIN
  ...
  -- WINNERS BRACKET - Round 1: 8 matches (16→8)
  FOR i IN 1..8 LOOP
  ...
  -- WINNERS BRACKET - Round 2: 4 matches (8→4)
  FOR i IN 1..4 LOOP
    INSERT INTO tournament_matches (
  ...
  -- WINNERS BRACKET - Round 3: 2 matches (4→2)
  FOR i IN 1..2 LOOP
    INSERT INTO tournament_matches (
      tournament_id, round_number, match_number, bracket_type, status
    ) VALUES (
  ...
  -- LOSERS BRANCH A - Round 101: 4 matches (8→4)
  FOR i IN 1..4 LOOP
    INSERT INTO tournament_matches (
      tournament_id, round_number, match_number, bracket_type, status
    ) VALUES (
  ...
  -- LOSERS BRANCH A - Round 102: 2 matches (4→2)
  FOR i IN 1..2 LOOP
    INSERT INTO tournament_matches (
      tournament_id, round_number, match_number, bracket_type, status
    ) VALUES (
  ...
  -- LOSERS BRANCH A - Round 103: 1 match (2→1)
  INSERT INTO tournament_matches (
    tournament_id, round_number, match_number, bracket_type, status
  ) VALUES (
  ...
  -- LOSERS BRANCH B - Round 201: 2 matches (4→2)
  FOR i IN 1..2 LOOP
    INSERT INTO tournament_matches (
      tournament_id, round_number, match_number, bracket_type, status
    ) VALUES (
  ...
  -- LOSERS BRANCH B - Round 202: 1 match (2→1)
  INSERT INTO tournament_matches (
    tournament_id, round_number, match_number, bracket_type, status
  ) VALUES (
  ...
  -- SEMIFINALS - Round 250: 2 matches (4→2)
  FOR i IN 1..2 LOOP
    INSERT INTO tournament_matches (
      tournament_id, round_number, match_number, bracket_type, status
    ) VALUES (
