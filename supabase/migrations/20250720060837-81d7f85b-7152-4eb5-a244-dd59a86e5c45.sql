-- Update complete_tournament_automatically function to work with single elimination tournaments
  ...
  position_calculated AS (
    SELECT 
      ...
      CASE 
        ...
        WHEN pa.player_id = v_third_place_winner_id THEN 3
        
        -- Fourth place: Third place match loser (if exists)
        WHEN pa.player_id = v_third_place_loser_id THEN 4
