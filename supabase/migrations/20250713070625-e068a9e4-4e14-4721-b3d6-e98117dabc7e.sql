-- Fix grant_spa_points function to use correct transaction_type
...
BEGIN
  ...
  -- Insert transaction record with correct transaction_type
  INSERT INTO public.spa_transactions (
    user_id, amount, transaction_type, category, description, admin_id, created_at
  ) VALUES (
    p_user_id, p_amount, 'credit', 'admin', p_reason, p_admin_id, NOW()
