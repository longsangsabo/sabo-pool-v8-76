-- Drop the existing function first, then recreate with correct logic
DROP FUNCTION IF EXISTS public.complete_any_tournament(uuid);

-- Create the corrected function with proper SPA and ELO calculation logic
...
BEGIN
  ...
  FOR v_participant IN
    WITH final_positions AS (
      ...
      LEFT JOIN tournament_matches tm ON tm.tournament_id = p_tournament_id 
