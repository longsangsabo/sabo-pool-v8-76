-- Fix the process_tournament_completion function to use correct column names
...
BEGIN
  ...
  -- Assign third and fourth place from third place match
  ...
  LOOP
    ...
    BEGIN
      ...
      -- Award SPA points (using user_id column)
      INSERT INTO public.spa_points_log (
        user_id,  -- Use user_id instead of player_id
        source_type, 
        source_id, 
        points_earned,
        description,
      ...
      -- Update player rankings (using user_id column)
