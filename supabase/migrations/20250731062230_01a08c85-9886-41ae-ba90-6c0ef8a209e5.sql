-- Update process_tournament_completion function to use actual prize tier data
...
BEGIN
  ...
  RETURN jsonb_build_object(
    ...
    'message', 'Tournament results processed with actual prize tier data'
  );
...
-- Re-run the function for the SABO Pool 8 Ball tournament to fix prize data
