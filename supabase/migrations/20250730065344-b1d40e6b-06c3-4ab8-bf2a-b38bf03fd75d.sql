-- Update test function to use correct Double1 setup function
...
BEGIN
  ...
  INSERT INTO tournaments (
    ...
    'Test Double1 Fix Tournament',
    'Testing exact Double1 pattern implementation',
    'double_elimination',
    16,
    'upcoming',
  ...
  -- Use setup_complete_double1_tournament for exact Double1 pattern
  SELECT setup_complete_double1_tournament(v_tournament_id, false) INTO v_result;
