-- Fix RLS policy for tournament_prize_tiers to allow system functions
-- Add policy to allow system functions (SECURITY DEFINER) to insert prize tiers
CREATE POLICY "System functions can manage tournament prize tiers" 
ON tournament_prize_tiers 
FOR ALL 
USING (true)
WITH CHECK (true);

-- Update the auto_apply_default_tournament_rewards function to work with RLS
...
-- Test the function with the tournament
