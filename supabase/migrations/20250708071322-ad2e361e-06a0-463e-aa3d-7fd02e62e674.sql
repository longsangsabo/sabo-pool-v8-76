-- Fix the seed_demo_users function with proper UUID generation
DROP FUNCTION IF EXISTS seed_demo_users();
...
BEGIN
  ...
  FOR i IN 1..array_length(demo_users, 1) LOOP
    ...
    IF NOT EXISTS (SELECT 1 FROM profiles WHERE phone = (user_data->>'phone')) THEN
