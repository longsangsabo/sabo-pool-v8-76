...
DECLARE
    ...
    v_match_1_record RECORD;
    v_match_2_record RECORD;
BEGIN
    ...
    -- Get the winner from Round 102 Match 1
    SELECT winner_id INTO v_round_102_winner_1
    ...
    -- Get the winner from Round 102 Match 2
    SELECT winner_id INTO v_round_102_winner_2
    FROM tournament_matches 
    WHERE tournament_id = v_tournament_id 
    AND round_number = 102 
    AND bracket_type = 'losers'
    ...
    RAISE NOTICE 'Round 102 Match 1 winner: %, Match 2 winner: %', v_round_102_winner_1, v_round_102_winner_2;
    ...
    ELSE
        RAISE NOTICE 'Cannot create Round 103 match - missing Round 102 winners. Winner 1: %, Winner 2: %', v_round_102_winner_1, v_round_102_winner_2;
    END IF;
