-- Create improved advance_winner_to_next_round function for Single Elimination
...
BEGIN
  ...
  -- Match 1,2 → Match 1 (winners from matches 1,2 meet in next round match 1)
  -- Match 3,4 → Match 2 (winners from matches 3,4 meet in next round match 2)
