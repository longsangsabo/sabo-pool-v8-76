-- Fix the process_challenge_completion function to use the correct existing column names
...
BEGIN
  ...
  -- Update challenge with scores and completion status using correct column names
