-- Fix the complete_tournament_automatically function to match actual table structure
...
BEGIN
  ...
  -- Insert new player rankings for players who don't have records (using correct column names)
  INSERT INTO player_rankings (user_id, spa_points, elo_points, total_matches, wins, tournament_wins, created_at, updated_at)
  SELECT 
    tr.user_id,
    tr.spa_points_earned,
