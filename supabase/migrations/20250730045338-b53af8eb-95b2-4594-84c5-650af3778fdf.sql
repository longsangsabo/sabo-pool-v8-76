-- Update the existing submit_match_score function to use Double1 advancement
...
BEGIN
  ...
  -- For double elimination tournaments, check if user is participant
  -- For other tournaments, allow admins and club owners to submit
