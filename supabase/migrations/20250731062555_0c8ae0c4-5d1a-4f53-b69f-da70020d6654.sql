-- Drop and recreate physical_rewards column with correct type
ALTER TABLE public.tournament_results 
DROP COLUMN IF EXISTS physical_rewards;

ALTER TABLE public.tournament_results 
ADD COLUMN physical_rewards text[] DEFAULT '{}';

-- Update process_tournament_completion function with correct data type handling
...
-- Re-run the function for the SABO Pool 8 Ball tournament
