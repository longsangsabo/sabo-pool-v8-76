-- Fix the create_double_elimination_bracket_v2 function to provide correct total_rounds value
...
BEGIN
  ...
  -- Store bracket metadata with correct total_rounds as integer
  INSERT INTO public.tournament_brackets (
    ...
    p_tournament_id,
    7, -- Total rounds: 3 winner + 2 loser + 1 semifinal + 1 final = 7
    16, -- Total players
    'double_elimination',
    jsonb_build_object(
      ...
      'rounds_breakdown', jsonb_build_object(
        'winner_bracket', 3,
        'loser_bracket', 2,
        'semifinal', 1,
        'final', 1
