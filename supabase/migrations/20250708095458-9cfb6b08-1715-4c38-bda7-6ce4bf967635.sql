-- Fix tournament_brackets insert to include required NOT NULL columns
...
BEGIN
  ...
  -- Insert bracket record with all required NOT NULL columns
  INSERT INTO public.tournament_brackets (
    tournament_id, bracket_data, total_rounds, total_players, bracket_type, created_at, updated_at
  ) VALUES (
    p_tournament_id, 
    v_bracket_data, 
    v_rounds,
