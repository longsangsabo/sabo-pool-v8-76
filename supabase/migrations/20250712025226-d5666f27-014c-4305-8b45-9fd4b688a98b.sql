-- Fix transaction_type in admin_credit_spa_points function to match check constraint
...
BEGIN
  ...
  -- Log transaction in spa_transactions table with proper transaction_type
  INSERT INTO public.spa_transactions (
    ...
    p_user_id,
    p_amount,
    'admin_adjustment', -- Changed from 'admin_credit' to match check constraint
    p_reason,
    gen_random_uuid(),
    'completed',
    p_admin_id
