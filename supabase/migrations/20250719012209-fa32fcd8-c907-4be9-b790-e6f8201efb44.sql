-- Drop all versions of the function to resolve overloading conflict
DROP FUNCTION IF EXISTS public.create_double_elimination_bracket_v2(uuid);
DROP FUNCTION IF EXISTS public.create_double_elimination_bracket_v2(uuid, text);
