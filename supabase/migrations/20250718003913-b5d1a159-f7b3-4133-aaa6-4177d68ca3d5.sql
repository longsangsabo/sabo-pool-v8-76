-- STEP 1: Backup existing data with proper column mapping
...
SELECT 
  ...
  COALESCE(score_player1, player1_score, 0) as score_player1,
  COALESCE(score_player2, player2_score, 0) as score_player2,
...
-- STEP 5: Restore data directly from backup
