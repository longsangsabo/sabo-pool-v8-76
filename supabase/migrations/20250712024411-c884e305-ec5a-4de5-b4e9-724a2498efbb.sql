-- Fix SPA credit functionality - add missing admin_id column and update function

-- Step 1: Add admin_id column to spa_transactions table
ALTER TABLE public.spa_transactions 
ADD COLUMN IF NOT EXISTS admin_id UUID REFERENCES public.profiles(user_id);

-- Step 2: Update admin_credit_spa_points function to properly handle admin_id
