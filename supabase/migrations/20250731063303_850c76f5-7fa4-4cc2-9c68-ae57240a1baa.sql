...
-- This version fixes the aggregate function FILTER issue
...
BEGIN
  ...
  WITH participant_stats AS (
    SELECT 
      ...
      COALESCE(MAX(CASE WHEN tm.player1_id = tr.user_id OR tm.player2_id = tr.user_id THEN tm.round_number END), 0) as last_round_reached
