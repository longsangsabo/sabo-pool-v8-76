-- Fix process_tournament_results function to include ALL participants
    ...
    LOOP
      ...
      BEGIN
        INSERT INTO public.tournament_results (
          ...
          v_points,
          CASE 
            WHEN v_participant.position = 1 THEN 50
            WHEN v_participant.position = 2 THEN 30
            WHEN v_participant.position = 3 THEN 20
            WHEN v_participant.position = 4 THEN 15
            WHEN v_participant.position <= 8 THEN 10
            ELSE 5
          END,
          CASE 
      ...
      BEGIN
        ...
        VALUES (v_participant.user_id, v_points, v_participant.total_matches, v_participant.wins, v_participant.losses)
