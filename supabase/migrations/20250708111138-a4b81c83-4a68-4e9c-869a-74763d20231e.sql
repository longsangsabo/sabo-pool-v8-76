-- Create demo users and tournament registration data with correct column names
...
DECLARE
    ...
    demo_users jsonb[] := ARRAY[
        ...
        '{"full_name": "Trần Thị Bình", "display_name": "Bình Master", "phone": "0901234002", "skill_level": "pro", "elo": 1300}',
        '{"full_name": "Lê Hoàng Cường", "display_name": "Cường Shark", "phone": "0901234003", "skill_level": "advanced", "elo": 1200}',
        '{"full_name": "Phạm Thị Dung", "display_name": "Dung Elite", "phone": "0901234004", "skill_level": "pro", "elo": 1400}',
        ...
        '{"full_name": "Bùi Thị Hà", "display_name": "Hà Lightning", "phone": "0901234008", "skill_level": "pro", "elo": 1350}',
        ...
        '{"full_name": "Phan Văn Long", "display_name": "Long Thunder", "phone": "0901234011", "skill_level": "pro", "elo": 1420}',
        ...
        '{"full_name": "Lại Văn Phú", "display_name": "Phú Force", "phone": "0901234015", "skill_level": "pro", "elo": 1380}',
        '{"full_name": "Hồ Thị Quỳnh", "display_name": "Quỳnh Star", "phone": "0901234016", "skill_level": "intermediate", "elo": 1040}',
        '{"full_name": "Châu Văn Rồng", "display_name": "Rồng Dragon", "phone": "0901234017", "skill_level": "pro", "elo": 1450}'
    ]::jsonb[];
    user_data jsonb;
...
BEGIN
    ...
    FOREACH user_uuid IN ARRAY created_user_ids
    LOOP
        INSERT INTO player_rankings (player_id, elo_points, spa_points, total_matches, wins)
        VALUES (
            user_uuid,
