-- Update auto_assign_tournament_tables function to support random assignment and use 'ready' status
...
BEGIN
  ...
  -- Assign tables to matches (both scheduled and ready status)
