-- Fix rank_verifications table constraints to use new 12-tier ranking system
...
-- Add new constraints with correct 12-tier ranks
ALTER TABLE public.rank_verifications 
...
-- Also fix rank_adjustments table constraints
