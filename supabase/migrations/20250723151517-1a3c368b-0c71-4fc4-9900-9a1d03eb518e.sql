-- 🔥 COMPREHENSIVE RANKING VERIFICATION SYSTEM FIX PLAN
...
-- ===============================================
-- 4. CLEANUP DEPRECATED FUNCTIONS
-- ===============================================

-- Drop old/conflicting rank request functions
DROP FUNCTION IF EXISTS public.handle_rank_request_approval();
DROP FUNCTION IF EXISTS public.notify_club_on_rank_request();
...
-- ===============================================
-- 6. ADD MISSING METADATA COLUMN TO NOTIFICATIONS
-- ===============================================
