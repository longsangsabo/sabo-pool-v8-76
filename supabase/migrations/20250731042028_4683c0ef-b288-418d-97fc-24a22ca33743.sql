-- Fix auto_apply_default_tournament_rewards - debug and use correct column names  
...
BEGIN
  ...
  v_debug_info := jsonb_build_object(
    ...
    'reward_structure_keys', (SELECT jsonb_object_keys(v_template.reward_structure))
  );
  ...
  LOOP
    ...
    INSERT INTO tournament_prize_tiers (
      ...
      COALESCE(v_items_array, ARRAY[]::text[])
    );
