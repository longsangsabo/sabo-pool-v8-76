      ...
      <div className="space-y-4 pb-20">
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <Badge variant="secondary" className="text-xs">
                    {profile.verified_rank ? profile.verified_rank : 'Người mới'}
                  </Badge>
                  <Badge variant="outline" className={`text-xs ${skillLevels[profile.skill_level].color}`}>
              ...
              <div className="text-right">
                <div className="text-lg font-racing-sans-one text-primary">6</div>
                <div className="text-xs text-muted-foreground">Trận đấu</div>
                <div className="text-sm font-medium text-green-600 mt-1">50%</div>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <Card className="h-20">
            <CardContent className="p-3 h-full flex flex-col justify-center">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-2xl font-racing-sans-one text-yellow-600">2225</span>
              </div>
              <div className="text-xs text-muted-foreground">SPA Points</div>
              <div className="text-xs text-green-600 font-medium">+50 tuần này</div>
            </CardContent>
          </Card>
          ...
          <Card className="h-20">
            <CardContent className="p-3 h-full flex flex-col justify-center">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-2xl font-racing-sans-one text-blue-600">#7</span>
              </div>
              <div className="text-xs text-muted-foreground">Xếp hạng tuần</div>
              <div className="text-xs text-green-600 font-medium">↗️ +3 bậc</div>
            </CardContent>
          </Card>
          ...
          <Card className="h-20">
            <CardContent className="p-3 h-full flex flex-col justify-center">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-2xl font-racing-sans-one text-orange-600">6</span>
              </div>
              <div className="text-xs text-muted-foreground">Trận tháng này</div>
              <div className="text-xs text-orange-600 font-medium">Tích cực</div>
            </CardContent>
          </Card>
        </div>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base font-epilogue">Hành động nhanh</CardTitle>
          </CardHeader>
          <CardContent className="p-4 pt-0">
            <div className="grid grid-cols-2 gap-3">
              <Button variant="default" size="sm" className="h-12 flex-col gap-1">
        ...
        <Card>
          ...
          <CardContent className="p-4 pt-0 space-y-3">
            <div className="flex items-center gap-3 p-2 bg-blue-50 rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-sm font-medium truncate">Tham gia giải đấu mới</div>
            ...
            <div className="flex items-center gap-3 p-2 bg-green-50 rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-sm font-medium truncate">Nhận 50 SPA Points</div>
            ...
            <div className="flex items-center gap-3 p-2 bg-yellow-50 rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-sm font-medium truncate">Cập nhật hồ sơ</div>
        ...
        <Card>
          ...
          <CardContent className="p-4 pt-0 space-y-3">
            <div className="flex items-center gap-3 p-2 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-sm font-medium truncate">Người mới xuất sắc</div>
                <div className="text-xs text-muted-foreground">Thắng 5 trận đầu tiên</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-2 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-muted-foreground">Độ chính xác &gt; 80%</div>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-sm font-racing-sans-one text-primary">{profile.completion_percentage || 0}%</span>
            </div>
